...
if ( $pgidx > 0 ) log_Access_ForPrivate("recruit2-categorylist-access");

$DBTable = "recruit_index_bi";
$pagecnt=$pagecnt;
$letter_no=$letter_no;
$offset=$offset;
if($searchstring) {
...
?>
    ...
    <script type="text/JavaScript">
        var list_delete_php = 'recruit_list_delete.php';
    ...
    <div align="left">
        <font color="#616161"><h4>교원채용관리(겸임)</h4></font>
                    ...
                    <table border="0" align="center" cellpadding="2" cellspacing="0">
                        <form name="searchForm" action="<?=$PHP_SELF?>" method="post" onSubmit="return searchSendit();">
                            ...
                            <tr>
                                <td>
                                    <select name="search">
                                        <option value="subject" <? if($search=="subject") echo "selected"; ?>>채용제목</option>
                                    </select>
                                </td>
        ...
        <table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#EEEEEE>
            <form name=fboardlist method=post>
                <tr align="center" height="30" bgcolor="#424a64">
                    ...
                    <td class="font_s01" width="150">제목</td>
                    <td width="150" class="font_s01">등록일</td>
                    <td class="font_s01" width="200">지원자보기</td>
                </tr>
                ...
                if($numrows<1) {
                    ...
                    for($i=0; $pg_row=mysql_fetch_array($pg_result); $i++)
                    {
                        ...
                        <tr align="center" height="30" bgcolor="#F9F9F9" OnMouseOver=style.background='#E1E4EC' OnMouseOut=style.background='#F9F9F9'>
                            ...
                            <td align="left"><a href="recruit_write.php?idx=<?=$pg_row[idx]?>"><?=$pg_row[subject]?></a></td>
                            <td align="center"><?=substr($pg_row[aq_datetime],0,10)?></td>
                            <td align="center"><input type="button" value="지원자보기" style="padding:5px 10px; border:0; background:#f53d3d;font-weight:bold;color:#FFFFFF;cursor:pointer" onclick="location.href='recruit.php?resume_gubun=<?=$pg_row[idx]?>'"/></td>
                        </tr>
                        <?
                        $letter_no--;
                    }
        ...
        <table style="padding-top:10px;" width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right"><input type="button" class='btn1' value='글쓰기' onclick="location.href='recruit_write.php'" style="cursor:pointer"></td>
            </tr>
        </table>
