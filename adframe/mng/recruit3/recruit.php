...
include_once( dirname(__FILE__)."/../recruit/lib/class.rList.php" );
// 접속로그
...
<style>
    ...
    <div align="left">
        <font color="#616161"><h4>강사채용관리</h4></font>
                            ...
                            <tr>
                                <td>
                                    <select name="apply_major" onchange="change_major()">
                                        ...
                                        <?php
                                        $major_sql="SELECT apply_major FROM recruit_te_copy WHERE apply_major <> '' GROUP BY apply_major ORDER BY apply_major ASC";
