...
if($_GET['gubun']) $search_qry = " AND gubun = '".$_GET['gubun']."'";
    ...
    <div align="left">
        ...
        <table style="padding-top:10px;" width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right"><input type="button" class='btn1' value='글쓰기' onclick="location.href='recruit_write.php?gubun=<?php echo $gubun?>'" style="cursor:pointer"></td>
            </tr>
        </table>
