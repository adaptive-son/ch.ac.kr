...
$pg_qry = "SELECT wr_id,kor_name,birth,department,phone,email,s_file_name2 FROM ".$DBTable." WHERE  wr_id > 0 AND resume_num='$resume_gubun' $search_qry $search_major ORDER BY wr_id desc LIMIT $offset,$LIMIT";
        ...
        <table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#EEEEEE>
            <form name=fboardlist method=post>
                <tr align="center" height="30" bgcolor="#424a64">
                    ...
                    <td class="font_s01" width="150">지원부서</td>
                    <td class="font_s01" width="150">휴대폰</td>
                    <td class="font_s01" width="*">이메일</td>
					<td class="font_s01" width="200">첨부파일</td>
                ...
                if($numrows<1) {
                    ...
                    for($i=0; $pg_row=mysql_fetch_array($pg_result); $i++)
                    {
                        ...
                        <tr align="center" height="30" bgcolor="#F9F9F9" OnMouseOver=style.background='#E1E4EC' OnMouseOut=style.background='#F9F9F9'>
                            ...
                            <td align="center"><?=$pg_row[department]?></td>
                            <td align="center"><?=$pg_row[phone]?></td>
                            <td align="center"><?=$pg_row[email]?></td>
							<td align="center"><a href="./download.php?idx=<?php echo $pg_row['wr_id']?>"><?=$pg_row['s_file_name2']?></a></td>
