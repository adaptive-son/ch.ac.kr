...
// 개인정보 접근로그
if ( $pgidx > 0 ) log_Access_ForPrivate("recruit-appinfo-view");
if($wr_id != ""){
    $sql = " select * from recruit_copy where wr_id = '$wr_id' ";
    $row = mysql_fetch_array(mysql_query($sql));
    $date = mysql_fetch_array(mysql_query("select * from recruit1 WHERE parent='$row[wr_id]'"));
    $school_addr = mysql_fetch_array(mysql_query("SELECT * FROM recruit_school_addr WHERe parent='$row[wr_id]'"));
}
?>
<style>
...
<table width="1000" class="table_box_recruit">
    ...
    <tr>
        <td colspan="8" class="sub_title" style="text-align:left;padding-left:10px;">
            접수번호 :
            <?=$row['apply_num']?>
            <?
            /*
                // 접수번호 표시 문제가 발생_데이터 입력시 문제 발생 예상
                $exp_apply_num = explode("-", $row[apply_num]);
                for ( $i = 0 ; $i < count($exp_apply_num)-1 ; $i++ ) {
                    $tmp .= $exp_apply_num[$i]."-";
                }
                echo $tmp;
                */
    ...
    <tr>
        ...
        <td colspan="2" rowspan="5"><?if($row[file_name]){?><img id="img_preview" src="<?=$row[file_name]?>" style="width: auto; max-width: 200px; height: 200px; max-height: 200px;" /><?}?></td>
    </tr>
    <tr>
        <th>지원학과</th>
    ...
    <tr>
        ...
        <td colspan="4" class="left">
            <div >
                (우편번호 :
                <?
                if ( $row[resume_num] >= 15 ) echo $row[zonecode];
                else $row[zip];
                ?>
                )
            </div>
    ...
    <tr>
        <th>현근무지</th>
        <td colspan="4" class="left"><?=$row[company]?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?=$row[hSchool]?></td>
        <td><?=$school_addr[hSchool_addr]?></td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
    </tr>
    <tr>
        ...
        <td><?=$row[colleage]?></td>
        <td><?=$school_addr[colleage_addr]?></td>
        <td><?=$row[cMajor]?></td>
    ...
    if($row[colleage1]){
        ...
        <tr>
            ...
            <td><?=$row[colleage1]?></td>
            <td><?=$school_addr[colleage1_addr]?></td>
            <td><?=$row[cMajor1]?></td>
    ...
    if($row[master1]){
        ...
        <tr>
            ...
            <td><?=$row[master1]?></td>
            <td><?=$school_addr[master1_addr]?></td>
            <td><?=$row[mMajor1]?></td>
    ...
    if($row[doctor1]){
        ...
        <tr>
            ...
            <td><?=$row[doctor1]?></td>
            <td><?=$school_addr[doctor1_addr]?></td>
            <td><?=$row[dMajor1]?></td>
    ...
    ?>
    <tr>
        <td colspan="8" class="sub_title">4. 경력사항(과거순으로 입력)<br />
※ 경력은 증빙서류를 첨부한 것만 인정되며, 최종 임용될 경우 자격 및 호봉 산출자료로 활용되오니 정확히 작성바랍니다.<br />
    ...
    if($row[etc7]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc7]?></td>
            <td colspan="3"><?=$row[etc7_date]?></td>
            <td colspan="2"><?=$row[etc7_company]?></td>
        </tr>
        <?php
    }
    if($row[etc8]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc8]?></td>
            <td colspan="3"><?=$row[etc8_date]?></td>
            <td colspan="2"><?=$row[etc8_company]?></td>
        </tr>
        <?php
    }
    if($row[etc9]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc9]?></td>
            <td colspan="3"><?=$row[etc9_date]?></td>
            <td colspan="2"><?=$row[etc9_company]?></td>
        </tr>
        <?php
    }
    if($row[etc10]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc10]?></td>
            <td colspan="3"><?=$row[etc10_date]?></td>
            <td colspan="2"><?=$row[etc10_company]?></td>
        </tr>
        <?php
    }
    if($row[etc11]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc11]?></td>
            <td colspan="3"><?=$row[etc11_date]?></td>
            <td colspan="2"><?=$row[etc11_company]?></td>
        </tr>
        <?php
    }
    if($row[etc12]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc12]?></td>
            <td colspan="3"><?=$row[etc12_date]?></td>
            <td colspan="2"><?=$row[etc12_company]?></td>
        </tr>
        <?php
    }
    if($row[etc13]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc13]?></td>
            <td colspan="3"><?=$row[etc13_date]?></td>
            <td colspan="2"><?=$row[etc13_company]?></td>
        </tr>
        <?php
    }
    if($row[etc14]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc14]?></td>
            <td colspan="3"><?=$row[etc14_date]?></td>
            <td colspan="2"><?=$row[etc14_company]?></td>
        </tr>
        <?php
    }
    if($row[etc15]){
        ?>
        <tr>
            <td colspan="3"><?=$row[etc15]?></td>
            <td colspan="3"><?=$row[etc15_date]?></td>
            <td colspan="2"><?=$row[etc15_company]?></td>
        </tr>
        <?php
    }
    ?>
...
<table class="table_box_recruit" style="margin:10px 0px;">
    ...
    <tr>
        <td>지도교수</td>
        <td colspan="4" class="left"><?=$date[thesis1_totor]?></td>
    </tr>
    <tr>
        <td>제목</td>
    ...
    <tr>
        <td>지도교수</td>
        <td colspan="4" class="left"><?=$date[thesis2_totor]?></td>
    </tr>
    <tr>
        <td>제목</td>
    ...
    if($date[study9_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study9_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study9_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study9_gubun=="3"]){echo "학술저서";}
                elseif($date[study9_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study9_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study9_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study9_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study9_subject]?></td>
            <td class="left"><?=nl2br($date[study9_content])?></td>
            <td><?=$date[study9_date]?></td>
            <td><?=$date[study9_mem]?></td>
            <td ><?=$date[study9_book]?></td>
        </tr>
        <?php
    }
    if($date[study10_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study10_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study10_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study10_gubun=="3"]){echo "학술저서";}
                elseif($date[study10_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study10_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study10_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study10_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study10_subject]?></td>
            <td class="left"><?=nl2br($date[study10_content])?></td>
            <td><?=$date[study10_date]?></td>
            <td><?=$date[study10_mem]?></td>
            <td ><?=$date[study10_book]?></td>
        </tr>
        <?php
    }
    if($date[study11_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study11_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study11_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study11_gubun=="3"]){echo "학술저서";}
                elseif($date[study11_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study11_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study11_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study11_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study11_subject]?></td>
            <td class="left"><?=nl2br($date[study11_content])?></td>
            <td><?=$date[study11_date]?></td>
            <td><?=$date[study11_mem]?></td>
            <td ><?=$date[study11_book]?></td>
        </tr>
        <?php
    }
    if($date[study12_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study12_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study12_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study12_gubun=="3"]){echo "학술저서";}
                elseif($date[study12_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study12_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study12_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study12_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study12_subject]?></td>
            <td class="left"><?=nl2br($date[study12_content])?></td>
            <td><?=$date[study12_date]?></td>
            <td><?=$date[study12_mem]?></td>
            <td ><?=$date[study12_book]?></td>
        </tr>
        <?php
    }
    if($date[study13_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study13_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study13_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study13_gubun=="3"]){echo "학술저서";}
                elseif($date[study13_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study13_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study13_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study13_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study13_subject]?></td>
            <td class="left"><?=nl2br($date[study13_content])?></td>
            <td><?=$date[study13_date]?></td>
            <td><?=$date[study13_mem]?></td>
            <td ><?=$date[study13_book]?></td>
        </tr>
        <?php
    }
    if($date[study14_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study14_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study14_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study14_gubun=="3"]){echo "학술저서";}
                elseif($date[study14_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study14_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study14_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study14_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study14_subject]?></td>
            <td class="left"><?=nl2br($date[study14_content])?></td>
            <td><?=$date[study14_date]?></td>
            <td><?=$date[study14_mem]?></td>
            <td ><?=$date[study14_book]?></td>
        </tr>
        <?php
    }
    if($date[study15_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study15_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study15_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study15_gubun=="3"]){echo "학술저서";}
                elseif($date[study15_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study15_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study15_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study15_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study15_subject]?></td>
            <td class="left"><?=nl2br($date[study15_content])?></td>
            <td><?=$date[study15_date]?></td>
            <td><?=$date[study15_mem]?></td>
            <td ><?=$date[study15_book]?></td>
        </tr>
        <?php
    }
    ?>
    ...
    if($date[study16_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study16_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study16_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study16_gubun=="3"]){echo "학술저서";}
                elseif($date[study16_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study16_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study16_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study16_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study16_subject]?></td>
            <td class="left"><?=nl2br($date[study16_content])?></td>
            <td><?=$date[study16_date]?></td>
            <td><?=$date[study16_mem]?></td>
            <td ><?=$date[study16_book]?></td>
        </tr>
        <?php
    }
    ?>
    ...
    if($date[study17_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study17_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study17_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study17_gubun=="3"]){echo "학술저서";}
                elseif($date[study17_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study17_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study17_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study17_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study17_subject]?></td>
            <td class="left"><?=nl2br($date[study17_content])?></td>
            <td><?=$date[study17_date]?></td>
            <td><?=$date[study17_mem]?></td>
            <td ><?=$date[study17_book]?></td>
        </tr>
        <?php
    }
    ?>
    ...
    if($date[study18_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study18_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study18_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study18_gubun=="3"]){echo "학술저서";}
                elseif($date[study18_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study18_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study18_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study18_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study18_subject]?></td>
            <td class="left"><?=nl2br($date[study18_content])?></td>
            <td><?=$date[study18_date]?></td>
            <td><?=$date[study18_mem]?></td>
            <td ><?=$date[study18_book]?></td>
        </tr>
        <?php
    }
    ?>
    ...
    if($date[study19_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study19_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study19_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study19_gubun=="3"]){echo "학술저서";}
                elseif($date[study19_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study19_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study19_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study19_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study19_subject]?></td>
            <td class="left"><?=nl2br($date[study19_content])?></td>
            <td><?=$date[study19_date]?></td>
            <td><?=$date[study19_mem]?></td>
            <td ><?=$date[study19_book]?></td>
        </tr>
        <?php
    }
    ?>
    ...
    if($date[study20_subject]){
        ...
        <tr>
            <td>
                <?
                if($date[study20_gubun]=="1"){echo "국내학술지 논문";}
                elseif($date[study20_gubun=="2"]){echo "국외학술지 논문";}
                elseif($date[study20_gubun=="3"]){echo "학술저서";}
                elseif($date[study20_gubun=="4"]){echo "국내 학술대회 발표";}
                elseif($date[study20_gubun=="5"]){echo "국외 학술대회 발표";}
                elseif($date[study20_gubun=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
                elseif($date[study20_gubun=="7"]){echo "기타";}
                ?>
            </td>
            <td ><?=$date[study20_subject]?></td>
            <td class="left"><?=nl2br($date[study20_content])?></td>
            <td><?=$date[study20_date]?></td>
            <td><?=$date[study20_mem]?></td>
            <td ><?=$date[study20_book]?></td>
        </tr>
        <?php
    }
    ?>
