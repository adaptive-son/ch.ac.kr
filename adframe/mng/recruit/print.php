...
if($wr_id != ""){
    ...
    $school_addr = mysql_fetch_array(mysql_query("SELECT * FROM recruit_school_addr WHERE parent='$data1[wr_id]'"));
...
<table width="1000" class="table_box_recruit">
    ...
    <tr>
        <td colspan="8" class="sub_title">1.지원사항</td>
    </tr>
    <tr>
        <th>지원학과</th>
        ...
        <td colspan="2" rowspan="3"><?if($data1[file_name]){?><img id="img_preview" src="<?=$data1[file_name]?>" style="width: auto; max-width: 200px; height: 150px; max-height: 150px;"/><?}?></td>
    </tr>
    <tr>
        <th>전공분야</th>
        <td colspan="2" class="left"><?=$data1[major]?></td>
        <th>지원구분</th>
        <td colspan="2" class="left"><?=$data1[gubun]?></td>
    </tr>
    <tr>
        <th>성명</th>
    ...
    <tr>
        <td colspan="8" class="sub_title">2.인적사항</td>
    </tr>
    <tr>
        <th>성별</th>
        <td><?=$data1[sex]?></td>
    ...
    <tr>
        ...
        <td colspan="2" rowspan="3" class="left">
            <div><span style="width:40px;display:inline-block">자택</span> : <?=$data[hTel]?></div>
    ...
    <tr>
        ...
        <td colspan="4" class="left">
            <div >
                (우편번호 :
                <?
                if ( $data1[resume_num] >= 15 ) echo $data1[zonecode];
                else echo $data1[zip];
                ?>
                )
            </div>
    ...
    ?>
    <tr>
        <td colspan="8" class="sub_title">4. 경력사항</td>
    </tr>
    <tr>
        <th colspan="3">기간</th>
