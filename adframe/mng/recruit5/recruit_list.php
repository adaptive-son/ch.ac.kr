...
$numresults=DBquery("SELECT wr_id FROM ".$DBTable." WHERE wr_id > 0 $search_qry ");
...
$pg_qry = "SELECT wr_id,kor_name,birth,apply_major,phone,email FROM ".$DBTable." WHERE  wr_id > 0 $search_qry ORDER BY wr_id desc LIMIT $offset,$LIMIT";
...
?>
    ...
    <script type="text/JavaScript">
        ...
        var list_delete_php = 'resume_list_delete.php';
    ...
    <div align="left">
                    ...
                    <table border="0" align="center" cellpadding="2" cellspacing="0">
                        <form name="searchForm" action="<?=$PHP_SELF?>" method="post" onSubmit="return searchSendit();">
                            ...
                            <tr>
                                ...
                                <td><input type="image" src="../app_iuk/images/search.gif" border="0" style="border:0px;"></td>
                            </tr>
                        </form>
                    </table>
                </td>
        ...
        <p style="text-align:right"><input type="button" value="엑셀저장" style="padding:10px 20px; border:0; background:#f53d3d;font-weight:bold;color:#FFFFFF;cursor:pointer" onclick="location.href='./recruit_excel.php'"/></p>
        <table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#EEEEEE>
            <form name=fboardlist method=post>
                <tr align="center" height="30" bgcolor="#424a64">
                    ...
                    <td class="font_s01" width="200">지원학과</td>
                    <td class="font_s01" width="150">휴대폰</td>
                    <td class="font_s01" width="*">이메일</td>
                    <td class="font_s01" width="100">인쇄</td>
                </tr>
                ...
                if($numrows<1) {
                    ...
                    for($i=0; $pg_row=mysql_fetch_array($pg_result); $i++)
                    {
                        ...
                        <tr align="center" height="30" bgcolor="#F9F9F9" OnMouseOver=style.background='#E1E4EC' OnMouseOut=style.background='#F9F9F9'>
                            ...
                            <td align="center"><input type="button" value="인쇄" style="padding:5px 10px; border:0; background:#f53d3d;font-weight:bold;color:#FFFFFF;cursor:pointer" onclick="GPEN_PRINT(<?=$pg_row['wr_id']?>)"/></td>
                        </tr>
                        <?
                        $letter_no--;
                    }
