...
a newer version is available with the same release state (stable config.)
...
',
    ...
    function doListUpgrades($command, $options, $params)
    {
        ...
        if (isset($params[0]) && !is_array(PEAR_Common::betterStates($params[0]))) {
            return $this->raiseError($params[0] . ' is not a valid state (stable/beta/alpha/devel/config.) try "pear help list-upgrades"');
        }
