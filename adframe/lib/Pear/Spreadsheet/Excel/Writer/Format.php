...
class Spreadsheet_Excel_Writer_Format extends PEAR
{
    ...
    *
    * @access private
    * @param string $name_color name of the color (i.e.: 'blue', 'red', config..). Optional.
    ...
    *
    * @access public
    * @param string $location alignment for the cell ('left', 'right', config...).
    */
    ...
    *
    * @access public
    * @param string $location alignment for the cell ('top', 'vleft', 'vright', config...).
    */
    ...
    * It can be date, time, currency, config...
    *
    * @access public
