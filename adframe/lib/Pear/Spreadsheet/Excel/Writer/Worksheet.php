...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    /**
    * Number of page to fit wide
    * @var integer
    */
    var $_fit_width;

    /**
    * Number of page to fit high
    * @var integer
    */
    var $_fit_height;
    ...
    */
    function setMerge($first_row, $first_col, $last_row, $last_col)
    {
        ...
        // don't check rowmin, rowmax, config... because we don't know when this
    ...
    */
    ...
    /**
    * Set the vertical and horizontal number of page that will define the maximum area printed.
    * It doesn't seem to work with OpenOffice.
    *
    * @access public
    * @param  integer $width  Maximun width of printed area in page
    * @param  integer $height Maximun heigth of printed area in page
    * @see setPrintScale()
    */
    ...
    */
    function _storeSetup()
    {
        ...
        $iFitWidth    = $this->_fit_width;    // Fit to number of page wide
        $iFitHeight   = $this->_fit_height;   // Fit to number of page high
