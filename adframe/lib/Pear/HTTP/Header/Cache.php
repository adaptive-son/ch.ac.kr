 ...
 * HTTP_Header_Cache
 * 
 * This package provides methods to easier handle caching of HTTP page.  That 
 * means that the page can be cached at the client (user agent or browser) and 
 * your application only needs to send "hey client you already have the page".
 * 
 ...
 * generated style sheets, or simply page that do only change rarely.
 * 
 * Usage:
 * <code>
