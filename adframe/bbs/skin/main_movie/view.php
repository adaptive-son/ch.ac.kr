...
<div class="board-area">
    ...
    <div class="board-view">
        ...
        <div class="board-contents pl0 pr0">

			<div class="pr-movie-wrapper">
				<div class="pr-movie-area">
					<div class="pr-movie-box">
					<iframe src="https://www.youtube.com/embed/<?=$view_row[etc_char1]?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
				<div class="pr-movie-script">
					<pre>
						<?
    ...
    <ul class="board-view-sns">
        ...
        <li style="display: inline">
            <a href="#none" onclick="fn_copy_url()">
                <img src="/_common/img/icon/icon_url01.jpg">
            </a>
        </li>
    </ul>
