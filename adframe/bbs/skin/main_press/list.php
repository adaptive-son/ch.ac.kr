...
<div class="board-area">
	...
	<div class="thumnbnail-list-wrapper02">
	<?
	...
	?>
		<div class="thumnbnail-area02">
			<p class="number">
				<?=$list_no?>
			</p>

			<a href="<?=$bbs_row['etc_char1']?>" class="image center-crop no-image" target="_blank" title="새창열림"><!-- 이미지 없을 때 class="no-image" 클래스 추가 -->
				<img src="<?=$upImg?>" alt="<?=$BBS_Title?>" />
			</a>

			<div class="thumnbnail-box02">
				<h4>
					<a href="<?=$bbs_row['etc_char1']?>" target="_blank" title="새창열림">
						<?=$bbs_row['title']?>
					</a>
				</h4>
				<ul class="media-report-list">
                    <? if ( !empty($bbs_row['etc_char3']) ) { ?>
					<li>
						<strong>
							<?=$bbs_row['etc_char2']?>
						</strong>
						<a href="<?=$bbs_row['etc_char3']?>" target="_blank" title="새창열림">
							바로가기
						</a>
					</li>
                    <? } ?>
                    <? if ( !empty($bbs_row['etc_char5']) ) { ?>
					<li>
						<strong>
							<?=$bbs_row['etc_char4']?>
						</strong>
						<a href="<?=$bbs_row['etc_char5']?>" target="_blank" title="새창열림">
							바로가기
						</a>
					</li>
                    <? } ?>
                    <? if ( !empty($bbs_row['etc_char7']) ) { ?>
					<li>
						<strong>
							<?=$bbs_row['etc_char6']?>
						</strong>
						<a href="<?=$bbs_row['etc_char7']?>" target="_blank" title="새창열림">
							바로가기
						</a>
					</li>
                    <? } ?>
