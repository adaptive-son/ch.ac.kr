			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Optometry 특화된 교육과정을 통한 비전케어 전문가 양성, 안경광학과는 시력검사에서부터 안경의 조제 및 가공, 콘택트렌즈, 안경렌즈와 안경테, 안경광학 등에 이르는 전문적인 지식을 통해 우수한 전문 안경사를 배출합니다.">
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=op&TREE_NO=9849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=op&TREE_NO=9861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=op&TREE_NO=9862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="1610";
														$boardList = BBS_GetList("bbs_op", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=op&TREE_NO=9863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1610";
														$boardList = BBS_GetList("bbs_op", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=op&TREE_NO=9863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1610";
														$boardList = BBS_GetList("bbs_op", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=op&TREE_NO=9863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1610";
														$boardList = BBS_GetList("bbs_op", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=op&TREE_NO=9863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="1621";
										$boardList = BBS_GetList("bbs_op", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="http://pf.kakao.com/_LCwdK" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_kakaotalk01.png" alt="KAKAOTALK" />
											</a>
										</li>	

										<li>
											<a href="https://youtu.be/ja1JXppZDvY" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://www.youtube.com/watch?v=g4S_buehBWA" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>

										<li>
											<a href="https://www.instagram.com/choonhae_optometry/" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/schedule/list.php?site_id=op&TREE_NO=9865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=op&TREE_NO=9850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=op&TREE_NO=9869&DEPTH=2">
											<span class="image center-crop">
