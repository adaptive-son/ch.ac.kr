			...
			<div class="main-container" id="container">
				...
				<article>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=ot&TREE_NO=7849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=ot&TREE_NO=7861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=ot&TREE_NO=7862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="1410";
														$boardList = BBS_GetList("bbs_ot", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=ot&TREE_NO=7863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1410";
														$boardList = BBS_GetList("bbs_ot", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=ot&TREE_NO=7863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1410";
														$boardList = BBS_GetList("bbs_ot", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=ot&TREE_NO=7863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1410";
														$boardList = BBS_GetList("bbs_ot", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=ot&TREE_NO=7863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1410";
														$boardList = BBS_GetList("bbs_ot", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=ot&TREE_NO=7863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="1423";
										$boardList = BBS_GetList("bbs_ot", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="http://pf.kakao.com/_hLPdK" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_kakaotalk01.png" alt="KAKAOTALK" />
											</a>
										</li>
										<li>
											<a href="https://www.facebook.com/ChoonHaeOT?mibextid=LQQJ4d" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_facebook01.png" alt="FACEBOOK" />
											</a>
										</li>

										<li>
											<a href="https://blog.naver.com/choonhaeot" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_blog01.png" alt="BLOG" />
											</a>
										</li>

										<li>
											<a href="https://youtube.com/@chot6800" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>

										<li>
											<a href="https://instagram.com/choonhae__ot" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_instagram01.png" alt="INSTAGRAM" />
											</a>
										</li>

										<li>
											<a href="https://cafe.naver.com/choonhaeot" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_cafe01.png" alt="CAFE" />
											</a>
										</li>
									</ul>
                                </div>    
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/schedule/list.php?site_id=ot&TREE_NO=7865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=ot&TREE_NO=7850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=ot&TREE_NO=7869&DEPTH=2">
											<span class="image center-crop">
					...
					<div class="main-contents03">
						<div class="main-contents-wrapper">
										...
										foreach ( $boardList as $k => $v ) {
											...
											if($v['file_src'] != ''){
												$upImg = $v['file_src'];
												 ...
												 if(preg_match("/<img[^>]*src=[\"']?([^>\"']+)[\"']?[^>]*>/i", $v['content'], $match)){
											...
											?>
											<li>
												<?if($_SERVER['REMOTE_ADDR']=="112.217.216.250") echo $data;?>
												<a href="<?=$view_linkUrl?>&data=<?=$v['linkdata']?>" class="main-news-box">
													<span class="image center-crop">
														<img src="<?=$upImg;?>" alt="<?=$v['title']?>">
													</span>
													<strong class="title">
														<?=$v['title']?>
													</strong>
							...
							<ul class="main-sns-list">
								...
								<li>
									<a href="https://www.facebook.com/ChoonHaeOT/" target="_blank" title="새창열림">
										<img src="../../_common/img/icon/icon_facebook01.png" alt="FACEBOOK" />
									</a>
								</li>
								...
								<li>
									<a href="https://www.youtube.com/channel/UCYUGCtCpF28Y_YbqRiXUx1g" target="_blank" title="새창열림">
										<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
									</a>
								</li>

								<li>
									<a href="https://www.instagram.com/chot_choonhae_ot/" target="_blank" title="새창열림">
										<img src="../../_common/img/icon/icon_instagram01.png" alt="INSTAGRAM" />
									</a>
								</li>
