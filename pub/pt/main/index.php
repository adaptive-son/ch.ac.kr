			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Physical Therapy 능독적이고 독립적인 물리치료사 양성, 물리치료과는 재활보건의료 전문역량을 갖춘 물리치료사를 양성하는 학과로, 세계물리치료연맹 권장 800시간 임상실습 프로그램을 시행하고 있습니다.">
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=pt&TREE_NO=11849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=pt&TREE_NO=11861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=pt&TREE_NO=11862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="1810";
														$boardList = BBS_GetList("bbs_pt", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=pt&TREE_NO=11863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1810";
														$boardList = BBS_GetList("bbs_pt", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=pt&TREE_NO=11863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1810";
														$boardList = BBS_GetList("bbs_pt", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=pt&TREE_NO=11863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1810";
														$boardList = BBS_GetList("bbs_pt", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=pt&TREE_NO=11863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1810";
														$boardList = BBS_GetList("bbs_pt", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=pt&TREE_NO=11863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="1823";
										$boardList = BBS_GetList("bbs_pt", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="http://pf.kakao.com/_InwdK" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_kakaotalk01.png" alt="KAKAOTALK" />
											</a>
										</li>

										<li>
											<a href="https://www.facebook.com/groups/chpt2010/?ref=share_group_link" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://www.instagram.com/choonhae_pt" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/board/board.php?site_id=pt&TREE_NO=11865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=pt&TREE_NO=11850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=pt&TREE_NO=11869&DEPTH=2">
											<span class="image center-crop">
