					...
					<div class="main-contents02">
						<div class="main-contents-wrapper">
										...
										<ul>
											<li>
												...
												<div class="main-board-box">
													...
													<a href="/pub/board/board.php?site_id=nurs&TREE_NO=5830&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													...
													<a href="/pub/board/board.php?site_id=nurs&TREE_NO=5830&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													...
													<a href="/pub/board/board.php?site_id=nurs&TREE_NO=5830&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													...
													<a href="/pub/board/board.php?site_id=nurs&TREE_NO=5830&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													...
													<a href="/pub/board/board.php?site_id=nurs&TREE_NO=5830&DEPTH=2&category=4학년" class="btn-more" title="4학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/pub/schedule/list.php?site_id=nurs&TREE_NO=5832&DEPTH=2">
									...
									<li>
										<a href="/pub/board/board.php?site_id=nurs&TREE_NO=15871&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/pub/board/board.php?site_id=nurs&TREE_NO=5837&DEPTH=2">
											<span class="image center-crop">
												<img src="../img/main/icon_menu0204.png" alt="동아리활동" />
											</span>
											<strong>
												동아리활동
											</strong>
									...
									<li>
										<a href="https://job.ch.ac.kr/" target="_blank" title="새창열림">
											<span class="image center-crop">
												<img src="../img/main/icon_menu0205.png" alt="학교이력시스템" />
											</span>
											<strong>
												학교이력시스템
											</strong>
									...
									<li>
										<a href="http://lms.ch.ac.kr/" target="_blank" title="새창열림">
											<span class="image center-crop">
												<img src="../img/main/icon_menu0206.png" alt="e-class" />
											</span>
											<strong>
												e-class
											</strong>
										...
										foreach ( $boardList as $k => $v ) {
											...
											<li>
												<a href="<?=$view_linkUrl?>&data=<?=$v['linkdata']?>" class="main-news-box">
													<span class="image center-crop">
														<img src="<?if($v['file_src'] != '') echo $v['file_src']; else echo "/pub/_common/img/common/noimg.jpg";?>" alt="<?=$v['title']?>">
													</span>
													<strong class="title">
														<?=$v['title']?>
													</strong>
