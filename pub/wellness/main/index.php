				...
				<article>
					<div class="main-contents01" id="contents">
								...
								<div class="swiper-container" id="main-visual-slider">
									<div class="swiper-wrapper">
										<div class="swiper-slide">
											<img src="../img/main/main_visual_pc001.jpg" alt="" class="pc"/>
											<img src="../img/main/main_visual_mobile001.jpg" alt="" class="mobile"/>

											<div class="main-slogan-wrapper01">
												<p class="word-eng">
													Department of Wellness Culture &amp; Tourism
												</p>
												<dl>
													<dt>
														<span>미래 관광산업을 선도할</span>
														<span>관광전문가 양성</span>
													</dt>
													<dd>
														<span>웰니스문화관광과는 건강한 여행을 창조하는 웰니스</span>
														<span>관광산업에서 요구하는 경쟁력 있는 인재를 양성하는</span>
														<span>학과입니다.</span>
													</dd>
												</dl>

												<p class="photo-sources">
													사진출처 - 울산관광 여행사진 선바위 가을
												</p>
											</div>
										</div>

										<div class="swiper-slide">
											<img src="../img/main/main_visual_pc002.jpg" alt="" class="pc"/>
											<img src="../img/main/main_visual_mobile002.jpg" alt="" class="mobile"/>
											...
											<div class="main-slogan-wrapper01">
												...
												<dl>
													<dt>
														<span>"국내여행안내사"</span>
														<span>국가자격취득을 통한</span>
														<span>현장실무교육</span>
													</dt>
												</dl>

												<p class="photo-sources">
													사진출처 - 울산관광 여행사진 태화뜰 국화꽃
												</p>
											</div>
										</div>

										<div class="swiper-slide">
											<img src="../img/main/main_visual_pc003.jpg" alt="" class="pc"/>
											<img src="../img/main/main_visual_mobile003.jpg" alt="" class="mobile"/>
											...
											<div class="main-slogan-wrapper01">
												...
												<p class="photo-sources">
													사진출처 - 울산관광 여행사진 바위섬 일출
												</p>
											</div>
										</div>

										<div class="swiper-slide">
											<img src="../img/main/main_visual_pc004.jpg" alt="" class="pc"/>
											<img src="../img/main/main_visual_mobile004.jpg" alt="" class="mobile"/>
											...
											<div class="main-slogan-wrapper01">
												...
												<dl>
													<dt>
														<span>성인학습자 중심의</span>
														<span>유연학사제도, 학습경험인증제</span>
														<span>(RPL) 운영</span>
													</dt>
												</dl>

												<p class="photo-sources">
													사진출처 - 울산관광 여행사진 대왕암 꽃필때
												</p>
											</div>
										</div>
									</div>
						...
						<div class="main-menu01-wrapper">
							...
							<div class="main-menu01-area">
								<a href="https://wellness.ch.ac.kr/contents/contents_view.php?site_id=wellness&TREE_NO=16354&DEPTH=2">
							...
							<div class="main-contents-area">
                                ...
                                <div class="video-gallery-wrapper">
									...
									<ul class="main-sns-list">
										...
										<li>
											<a href="https://www.youtube.com/@user-dr2fn2xz2e" target="_blank" title="새창열림">
												<img src="../img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>

										<li>
											<a href="https://www.instagram.com/choonhae_tour2024/" target="_blank" title="새창열림">
