							...
							<!-- CMS 시작 -->
								<div class="tabmenu-wrapper ratio"><!-- 탭 크기 동일한 비율로 작성할때 ratio 추가 -->
									<ul class="depth4"> <!-- 기본 2개 depth3 depth4 depth5 ..형식으로 구성됨-->
										...
										<!--<li class="topmenu1-5-2">
											<a href="../sub01/sub0502.php">
												2019학년도
											</a>
										</li>-->
										<!--<li class="topmenu1-5-3">
											<a href="../sub01/sub0503.php">
												2018학년도
											</a>
										</li>-->
										<!--<li class="topmenu1-5-4">
											<a href="../sub01/sub0504.php">
												2017학년도
											</a>
										</li>--> 
									</ul>
								...
								<div class="btns-area pt0">
									<div class="btns-right">
										<a href="../pdfjs/web/schdule_wellness2024.zip" class="btn-download type01 depth2">
											<span>
												<strong>
													PDF 다운로드
												</strong>
								...
								<div class="contents-area">
									<iframe class="div-pdf" src="../pdfjs/web/viewer.html?file=schdule_wellness2024.pdf" title="춘해보건대학교 - 웰니스문화관광과"></iframe>
								</div>
							<!-- //CMS 끝 -->
							</div>
						</div>
