				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							<img src="../img/main/main_visual_pc04.jpg" alt="메인이미지" class="pc"/>
							<img src="../img/main/main_visual_mobile04.jpg" alt="메인이미지" class="mobile"/>
							
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Emergency Medical Technology 고귀한 인명을 구조하는 전문응급구조사 양성, 춘해보건대학교 응급구조과는 사고현장에서 신속한 응급처치를 제공하는 1급 응급구조사를 양성하는 학과로 학사학위 전공심화과정을 통하여 4년제 학사학위 취득도 가능합니다." />
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=eh&TREE_NO=8849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=eh&TREE_NO=8861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=eh&TREE_NO=8862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="1510";
														$boardList = BBS_GetList("bbs_eh", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=eh&TREE_NO=8863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1510";
														$boardList = BBS_GetList("bbs_eh", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=eh&TREE_NO=8863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1510";
														$boardList = BBS_GetList("bbs_eh", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=eh&TREE_NO=8863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1510";
														$boardList = BBS_GetList("bbs_eh", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=eh&TREE_NO=8863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1510";
														$boardList = BBS_GetList("bbs_eh", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=eh&TREE_NO=8863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="1523";
										$boardList = BBS_GetList("bbs_eh", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<!-- 응급구조과에만 있는 동영상 갤러리 버튼 -->
									<a href="/board/board.php?site_id=eh&TREE_NO=16366&DEPTH=2" class="btn-more" title="동영상 갤러리 더보기">
										<img src="../img/main/icon_more01.gif">
									</a>
									<!-- //응급구조과에만 있는 동영상 갤러리 버튼 -->
									<ul class="main-sns-list">
										<li>
											<a href="https://open.kakao.com/o/seSV2waf" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://youtube.com/@FOREVER-ys4gt" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>

										<li>
											<a href="https://instagram.com/choonhae_emt?igshid=MmIzYWVlNDQ5Yg==" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/board/board.php?site_id=eh&TREE_NO=8865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=eh&TREE_NO=8850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=eh&TREE_NO=8869&DEPTH=2">
											<span class="image center-crop">
