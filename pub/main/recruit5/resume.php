                ...
                <article>
                    <div class="contents" id="contents">
                        ...
                        if($j=="u"){
                            ...
                            $dateSql = "SELECT * FROM recruit_research WHERE parent='$row[wr_id]'";
                            $dateRes = mysql_query($dateSql);
                            $date = mysql_fetch_array($dateRes);

                            if($row > 0){
                                $sql_chk = "SELECT * FROM recruit_research WHERE parent='$wr_id' AND password='$password'";
                        ...
                        */
                        ...
                        <script type="text/javascript">
                            function GPEN_PRINT(wr_id){
                                ...
                                var p = window.open("/adframe/mng/recruit5/print.php?wr_id="+wr_id,"PrintWin","width=800, height=700, scrollbars=yes");
                                p.focus();
                            }
                            function GPEN2_PRINT(wr_id){
                               // alert("팝업이 뜨면 인쇄를 한번더 클릭해주세요.\n 인터넷 익스플로러에서만 인쇄가 가능합니다.");
                                var p = window.open("/adframe/mng/recruit5/print2.php?wr_id="+wr_id,"PrintWin","width=800, height=700, scrollbars=yes");
                                p.focus();
                            }
                            function GPEN3_PRINT(wr_id){
                                //alert("팝업이 뜨면 인쇄를 한번더 클릭해주세요.\n 인터넷 익스플로러에서만 인쇄가 가능합니다.");
                                var p = window.open("/adframe/mng/recruit5/print3.php?wr_id="+wr_id,"PrintWin","width=800, height=700, scrollbars=yes");
                                p.focus();
                            }
...
&nbsp;&nbsp;나. E-mail로는 접수받지 않습니다.
                            ...
                            <div class="cont">
                                <h5 class="title-type02">춘해보건대학교 연구교원 초빙 이력서</h5>
                                <?php
                                if ( $j == "u" ) {
                                    ?>
                                    <p>
                                ...
                                <form name="frm" method="POST" action="proc.php" onsubmit="return check_form(this)" enctype="multipart/form-data"  >
                                    ...
                                    <table class="table_box_recruit">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" id="td_type_gubun">연구교원
                                                <input type="hidden" name="type_gubun" value="연구교원">
                                            </td>
