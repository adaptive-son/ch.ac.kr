...
*/
	...
	if ( $j == "" ) {
		$dup_check_sql = " select wr_id from recruit_copy where kor_name = '".addslashes($kor_name)."' and phone = '".addslashes($phone)."' and resume_num = '".addslashes($resume_num)."' ";
	...
	$thesis1_tutor = addslashes($thesis1_tutor);
	...
	$thesis2_tutor = addslashes($thesis2_tutor);
	...
	$study1_author = addslashes($study1_author);
	...
	$study2_author = addslashes($study2_author);
	...
	$study3_author = addslashes($study3_author);
	...
	$study4_author = addslashes($study4_author);
	...
	$study5_book = addslashes($study5_book);
	$study5_author = addslashes($study5_author);
	...
	$study6_author = addslashes($study6_author);
	...
	$study7_author = addslashes($study7_author);
	...
	$study8_author = addslashes($study8_author);
	$study9_gubun = addslashes($study9_gubun);
	$study9_subject = addslashes($study9_subject);
	$study9_content = addslashes($study9_content);
	$study9_date = addslashes($study9_date);
	$study9_mem = addslashes($study9_mem);
	$study9_book = addslashes($study9_book);
	$study9_author = addslashes($study9_author);
	$study10_gubun = addslashes($study10_gubun);
	$study10_subject = addslashes($study10_subject);
	$study10_content = addslashes($study10_content);
	$study10_date = addslashes($study10_date);
	$study10_mem = addslashes($study10_mem);
	$study10_book = addslashes($study10_book);
	$study10_author = addslashes($study10_author);
	$study11_gubun = addslashes($study11_gubun);
	$study11_subject = addslashes($study11_subject);
	$study11_content = addslashes($study11_content);
	$study11_date = addslashes($study11_date);
	$study11_mem = addslashes($study11_mem);
	$study11_book = addslashes($study11_book);
	$study11_author = addslashes($study11_author);
	$study12_gubun = addslashes($study12_gubun);
	$study12_subject = addslashes($study12_subject);
	$study12_content = addslashes($study12_content);
	$study12_date = addslashes($study12_date);
	$study12_mem = addslashes($study12_mem);
	$study12_book = addslashes($study12_book);
	$study12_author = addslashes($study12_author);
	$study13_gubun = addslashes($study13_gubun);
	$study13_subject = addslashes($study13_subject);
	$study13_content = addslashes($study13_content);
	$study13_date = addslashes($study13_date);
	$study13_mem = addslashes($study13_mem);
	$study13_book = addslashes($study13_book);
	$study13_author = addslashes($study13_author);
	$study14_gubun = addslashes($study14_gubun);
	$study14_subject = addslashes($study14_subject);
	$study14_content = addslashes($study14_content);
	$study14_date = addslashes($study14_date);
	$study14_mem = addslashes($study14_mem);
	$study14_book = addslashes($study14_book);
	$study14_author = addslashes($study14_author);
	$study15_gubun = addslashes($study15_gubun);
	$study15_subject = addslashes($study15_subject);
	$study15_content = addslashes($study15_content);
	$study15_date = addslashes($study15_date);
	$study15_mem = addslashes($study15_mem);
	$study15_book = addslashes($study15_book);
	$study15_author = addslashes($study15_author);
	$study16_gubun = addslashes($study16_gubun);
	$study16_subject = addslashes($study16_subject);
	$study16_content = addslashes($study16_content);
	$study16_date = addslashes($study16_date);
	$study16_mem = addslashes($study16_mem);
	$study16_book = addslashes($study16_book);
	$study16_author = addslashes($study16_author);
	$study17_gubun = addslashes($study17_gubun);
	$study17_subject = addslashes($study17_subject);
	$study17_content = addslashes($study17_content);
	$study17_date = addslashes($study17_date);
	$study17_mem = addslashes($study17_mem);
	$study17_book = addslashes($study17_book);
	$study17_author = addslashes($study17_author);
	$study18_gubun = addslashes($study18_gubun);
	$study18_subject = addslashes($study18_subject);
	$study18_content = addslashes($study18_content);
	$study18_date = addslashes($study18_date);
	$study18_mem = addslashes($study18_mem);
	$study18_book = addslashes($study18_book);
	$study18_author = addslashes($study18_author);
	$study19_gubun = addslashes($study19_gubun);
	$study19_subject = addslashes($study19_subject);
	$study19_content = addslashes($study19_content);
	$study19_date = addslashes($study19_date);
	$study19_mem = addslashes($study19_mem);
	$study19_book = addslashes($study19_book);
	$study19_author = addslashes($study19_author);
	$study20_gubun = addslashes($study20_gubun);
	$study20_subject = addslashes($study20_subject);
	$study20_content = addslashes($study20_content);
	$study20_date = addslashes($study20_date);
	$study20_mem = addslashes($study20_mem);
	$study20_book = addslashes($study20_book);
	$study20_author = addslashes($study20_author);
	$pass = addslashes($pass);
	$hSchool_addr = addslashes($hSchool_addr);
	$colleage_addr = addslashes($colleage_addr);
	$colleage1_addr = addslashes($colleage1_addr);
	$univ_addr = addslashes($univ_addr);
	$univ1_addr = addslashes($univ1_addr);
	$master_addr = addslashes($master_addr);
	$master1_addr = addslashes($master1_addr);
	$doctor_addr = addslashes($doctor_addr);
	$doctor1_addr = addslashes($doctor1_addr);
	...
	if($j==""){
		...
		if(!$result1) error_log("recruit/proc.php INSERT recruit1 실패 (wr_id=$wr_ins_id): ".mysql_error());
		$sql2 = "INSERT recruit_school_addr SET parent = '$wr_ins_id',$query3";
		$result2 = mysql_query($sql2);
		if(!$result2) error_log("recruit/proc.php INSERT recruit_school_addr 실패 (wr_id=$wr_ins_id): ".mysql_error());
		if($result && $result1 && $result2){

			echo "<script>alert('이력서가 정상적으로 접수되었습니다.');location.href='./resume.php?j=u&wr_id=$wr_ins_id&pass=".base64_encode($pass)."'</script>";
		}else{
		...
		$result1 = mysql_query($sql1);
		if(!$result1) error_log("recruit/proc.php UPDATE recruit1 실패 (wr_id=$wr_id): ".mysql_error());
		$sql2 = "UPDATE recruit_school_addr SET $query3 WHERE parent='$wr_id'";
		//print_R($sql2);exit;
		$result2 = mysql_query($sql2);
		if(!$result2) error_log("recruit/proc.php UPDATE recruit_school_addr 실패 (wr_id=$wr_id): ".mysql_error());
		if($result && $result1 && $result2){
