...
include_once ($_SERVER["DOCUMENT_ROOT"] . "../../_common/main_design.php");

include_once ($_SERVER["DOCUMENT_ROOT"] . "../../_common/menu2.php");
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-B0FSRTL2VK"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-B0FSRTL2VK');
</script>
<!--
