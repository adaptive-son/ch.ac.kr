            ...
            <div class="container-wrapper">
                ...
                if ( $j == "u" ) {
                    ...
                    if ( mysql_num_rows($rs) == 0 ) {
                        ...
                        // 입력 정보 확인
                        $sql_chk = " select * from recruit_te where parent = '".$row[wr_id]."' and password = '".$password."' ";
                ...
                */
                ...
                /*$arr_impClass = array(
                    "간호학과" => array("간호학","정년과정(산학협력 중점교원)"),
                    "응급구조과" => array("응급구조학|의학|간호학|보건학|소방학","비정년과정(산학협력 중점교원)"),
                );*/
                ...
                <script>
                    // 2017학년도 1학기 이후 채용공고 ( resume_num(Pri-Key) = 15 ) 에서 사용되는 스크립트
                    ...
                    function select_apply_major_change ( obj ) {
                        ...
                        if ( type_gubun_val.length > 0 ) {
                            ...
                            for ( var i = 0 ; i < exp_type_gubun_val.length ; i++ ) {
                                tmpHTML += "<input type='radio' name='type_gubun' value='" + exp_type_gubun_val[i] + "' ";
                                if ( "<?=$j?>" == "u" && exp_type_gubun_val[i] == "<?=$date[type_gubun]?>" ) {
                                    tmpHTML += " checked ";
                                }
                                tmpHTML += " > " + exp_type_gubun_val[i] + "&nbsp;";
                                // 줄바꿈
                                if ( i != 0 && i%2 == 1 ) {
                                    tmpHTML += "<BR>";
                                }
                        ...
                        if ( gubun_val.length > 0 ) {
                            ...
                            for ( var i = 0 ; i < exp_gubun_val.length ; i++ ) {
                                tmpHTML += "<input type='radio' name='gubun' value='" + exp_gubun_val[i] + "' ";
                                if ( "<?=$j?>" == "u" && exp_gubun_val[i] == "<?=$row[gubun]?>" ) {
                                    tmpHTML += " checked ";
                                }
                                tmpHTML += "> " + exp_gubun_val[i] + "&nbsp;";
                                // 줄바꿈
                                if ( i != 0 && i%2 == 1 ) {
                                    tmpHTML += "<BR>";
                                }
                ...
                <script type="text/javascript">
                    function check_form(f){
                        ...
                        if(f.major.value==""){alert("초빙분야 구분번호를 입력하세요.");f.major.focus(); return false;}
						if(f.damdang_class.value==""){alert("담당과목명을 입력하세요.");f.damdang_class.focus(); return false;}
                ...
                <script type="text/javascript">
                    function GPEN_PRINT(wr_id){
                        var p = window.open("/adframe/mng/recruit3/print.php?wr_id="+wr_id,"PrintWin","width=800, height=700, scrollbars=yes");
                        p.focus();
                    }
                    function GPEN2_PRINT(wr_id){
                        var p = window.open("/adframe/mng/recruit3/print2.php?wr_id="+wr_id,"PrintWin","width=800, height=700, scrollbars=yes");
                        p.focus();
                    }
                    function GPEN3_PRINT(wr_id){
                        var p = window.open("/adframe/mng/recruit3/print3.php?wr_id="+wr_id,"PrintWin","width=800, height=700, scrollbars=yes");
                        p.focus();
                    }
                </script>
...
&nbsp;&nbsp;나. E-mail로는 접수받지 않습니다.
                            ...
                            <div class="cont">
                                <h5 class="title-type02">춘해보건대학교 강사 초빙 이력서</h5>
                                <?php
                                if ( $j == "u" ) {
                                    ?>
                                    <p>
                                    ...
                                    <table class="table_box_recruit">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" id="td_type_gubun">
                                                강사초빙
                                                <input type="hidden" name="type_gubun" value="강사초빙">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" id="damdang_class">
                                                <input type="text" name="damdang_class" value="<?php echo $row['damdang_class']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>성명</th>
                                        ...
                                        <th colspan="2">시행기관</th>
                                            ...
                                            <td colspan="6" class="sub_title">
                                                <span style="color:red;font-size:150%">*</span>
                                                    &nbsp;
                                                    자기소개서
                                                    <div style="float:right;color:red">특수문자(당구장표시, 가운데점 등)은 사용할 수 없습니다.</div>
                                            </td>
                                        </tr>
                                        <tr>
                                        <td colspan="6">
										<textarea name="profile" style="width:98%; height:300px;">
 - 자기소개서는 본인의 강의 교과목에 대한 전공의 이해, 교육 가치관 등 교육역량을 평가할 수 있는 내용을 중심으로 작성 하여 주시기 바랍니다. (1페이지 이내 작성)
