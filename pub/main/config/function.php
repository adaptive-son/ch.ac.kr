...
function cms_view($cms_id){
	...
	if(empty($cms_id))	echo "<div style=' text-align:center; padding:100px 0; '>CMS �ڵ尡 �����ϴ�.</div>";
	...
	<div id="page_inc"> 
		          <div class="page_com"> 
		            <p class="page_h"><img src="/make_img/page/txt1.gif" width="115" height="22" alt="����������� �ȳ��Դϴ�."></p> 
		            <ul class="page_table"> 
		              <li class="page_bn1"><img src="/make_img/page/o.gif" width="16" height="13"><strong>�����</strong> :
		                 '.$damdang_name.'
		              </li> 
		              <li class="page_bn2"><img src="/make_img/page/o.gif" width="16" height="13"><strong>��ȭ��ȣ</strong> :
		                 '.$damdang_tel.'
		              </li> 
		              <li class="page_bn3"><img src="/make_img/page/o.gif" width="16" height="13"><strong>�ֱپ�����Ʈ</strong> :
		                '.$cms_date.'
		              </li> 
		              <li class="page_bn4"><a href="javascript:cms_bookmarksite()"><img src="/make_img/page/add_btn.gif" alt="���ã��" width="68" height="18"></a><a href="javascript:print();"><img src="../../make_img/page/print_btn.gif" alt="����Ʈ" width="72" height="18"></a></li> 
		            </ul> 
		          </div> 
		        </div> 
		...
		$cms_copy = '
				<!-- ������ ����ھȳ� -->
				 <div class="fdata_wrap"> 
		          <dl> 
		             <dt><img src="/make_img/page/txt1.gif" alt="����������� �ȳ��Դϴ�."/></dt> 
		             <dd> 
		              <ul> 
		                 <li><span class="ctit">����� : </span><span class="ctxt">'.$damdang_name.'</span></li> 
		                 <li><span class="ctit">��ȭ��ȣ : </span><span class="ctxt">'.$damdang_tel.'</span></li> 
		                 <li class="last"><span class="ctit">�ֱپ�����Ʈ : </span><span class="ctxt">'.$cms_date.'</span></li> 
		               </ul> 
		         ...
		         <div class="fdata_wrap"> 
		          <dl> 
		             ...
		             <dd> 
		              ...
		              <div class="btn_print"><a href="#n" onclick="cms_bookmarksite()"><img src="/make_img/page/add_btn.gif" alt="���ã��" /></a> <a href="#n" onclick="print();" /><img src="/make_img/page/print_btn.gif" alt="����Ʈ" /></a> </div> 
		            </dd> 
		           </dl> 
		        </div> 
				<!-- ������ ����ھȳ� -->
...
//BBS_GetList("�Խ��� ���̺���(fullname)", "�Խ����ڵ�", ����Ÿ��, �迭�� ���� �ֱٰԽù� ��, ����� ��:html�����̶� 300�̻����� ��ƾ�...);
/*
	$board_type=0 : �Ϲ�
	$board_type=1 : ������
	$board_type=2 : UCC
	...
	for($i=0; $i < count($newlist1); $i++){
		...
		//echo $newlist1[$i][title]."<br>"; //����
		
		//echo $newlist1[$i][content]."<br>"; //����
		
		//echo $newlist1[$i][linkdata]."<br>"; //��ũ����Ÿ  <a href='���ϸ�?bbs=see&data=$newlist1[$i][linkdata]'>
		//echo $newlist1[$i][file_src]."<br>"; //���ϰ�� <img src='$newlist1[$i][file_src]'> width height�� ����
		
		//echo $newlist1[$i][datetime]."<br>"; //�������
		//echo $newlist1[$i][newimg]."<br>"; //���� ������
...
function getSendMail($to, $from, $subject, $message, $html)
{
	...
	$smtpServer = "������"; //ip accepted as well
	$port = "25"; // should be 25 by default
	$timeout = "30"; //typical timeout. try 45 for slow servers
	$username = "���̵�"; //the login for your smtp
	$password = "�н�����"; //the pass for your smtp
...
/*	
	...
	$secure = 0; //change to 1 if you need a secure connect
*/
//smtp ��� way_nam :: ����24�� smtp �� Ȱ���Ͽ� �����ϴ�. (�뷮���Ͽ��� ����ϸ� �ȉ?�Ϸ� �߼���������)
...
function setQuery ($arr, $str) {
	...
	// $arr : $_POST Ȥ�� $_GET, �迭 �ݺ�
	foreach ($arr as $key=>$val) {

		// input name �� ������ ���ڿ��� ���۵Ǹ� ���� �ϰ� �� ���ڿ��� ���� 
		//if (@ereg ("^$str", $key)) { // php 5.3���� ����������Ʈ 6.0���ͻ���
		if(preg_match("/^$str/", $key)) {
			
			//$key = @ereg_replace ("^$str", "", $key);  // php 5.3���� ����������Ʈ 6.0���ͻ���
			$key = preg_replace ("/^$str/", "", $key);

			// ���ڿ��� ������ Ű���� ���� �����ϸ� �������� ���ڿ��� �����մϴ�.
			// ó���� xxx = 'xxx' �� �ι�° ���ʹ� ,xxx = 'xxx'�� �̾��ݴϴ�.
			if (!empty($key)) { 
				if (!empty($r_str)) {
					$r_str .= ', ';
				}
...
function pageLink($args) {
	...
	//print_r($args);
	$tp = @floor(($args['total_row']-1)/$args['row_num'] +1 ); //(TotalPage)��ü ������ ��
	if($tp == 0) $tp = 1;
	$sp = (floor(($args['p']-1)/$args['page'])) * $args['page'] + 1; //������ ���� ǥ�� --> ����
	$ep = $sp + $args['page']; //������ ���� ǥ�� --> ��
	//echo $tp;
	...
	//$prev ; 
	//$prev = $sp - 1;
	$prev = $sp - ($args['page']);	// ���� ������ ����Ʈ ���� ù�������� ������ ����(2005.05.18 ��â��)
	$next = $sp + $args['page'];
	if($sp != 1) {
...
function script($script) {	// �ڹٽ�ũ��Ʈ ����, �迭�� ������ ������ ����
	echo "<script>\n";
	if(is_array($script)) {
...
function readHtml($readfile)
{
	...
	{
		$rtStr = "<h1>Warning</h1><hr>���� ȭ���� ���ų� ȭ�ϸ��� �߸� �����Ǿ����ϴ�.";
		$rtStr .= "<br>ȭ�ϸ��� Ȯ���Ͻʽÿ�!";
...
# @parameter
#		$html_ini   	: �ʱ�ȭ�� ���̺�����ȭ��
# @Return         : html_table,html_t1,html_2�� ���������� �Ҵ�
#-----------------------------------------------------------------------------
...
class SList
{
	...
	// SList(��������, ������������ȣ, DB����offset, �ѰԽù���, ��������������, ��������Խù���, �˻��÷�, �˻���, �߰�get��)
	//
	...
	function putList($pniView,$pre_icon,$next_icon){
		$this->g_pniView=$pniView;					//��ũ���� ���� ������ ǥ�� ����
		if(empty($pre_icon))	$this->g_pIcon="[���� ".$this->g_pageBlock."��]";			//���� ������ ����
		else			$this->g_pIcon=$pre_icon;

		if(empty($next_icon))	$this->g_nIcon="[���� ".$this->g_pageBlock."��]";			//���� ������ ����
		else			$this->g_nIcon=$next_icon;
