        ...
        <div class="container" id="container">
            ...
            <article>
                <div class="contents" id="contents">
                    ...
                    <!-- contents-wrapper -->
                    <div class="contents-wrapper" style="text-align:center">
						<div class="btns-area mb35">
							<div class="btns-left">
								<a href="/sub01/iOS.php" target="_blank" class="btn download03">
									<span class="name1">
										아이폰 사용자용 스마트 클라스 연결방법 보기
									</span>
								</a>

								<a href="/sub01/android.php" target="_blank" class="btn download03 active02">
									<span class="name1">
										안드로이드폰 사용자용 스마트 클라스 연결방법 보기
									</span>
								</a>
						...
						<video controls="" width="400px">
						  <source src="/video/2.Android.mp4" type="video/mp4">
						</video>
					</div>
                    <!-- //contents-wrapper -->
                </div>
