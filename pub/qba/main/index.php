				...
				<article>
					<div class="main-contents01" id="contents">
									...
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide">
											...
											<div class="main-slogan-wrapper01">
												<p class="word-eng">
													Department of Behavior Analysis & Rehabilitation Convergence
												</p>
												<dl>
													<dt>
														<span>행동의 기능을 이해하고,</span>
														<span>변화의 가능성을 분석하다</span>
													</dt>
													<dd>
														<span>Understanding the Function of Behavior,</span>
														<span>Analyzing the Possibility of Change</span>
													</dd>
												</dl>
											</div>
										</div>
						...
						<div class="main-menu01-wrapper">
							...
							<div class="main-menu01-area">
								<a href="/contents/contents_view.php?site_id=qba&TREE_NO=16588&DEPTH=2">
							...
							<div class="main-menu01-area">
								<a href="/board/board.php?site_id=qba&TREE_NO=16597&DEPTH=2">
							...
							<div class="main-menu01-area">
								<a href="/contents/contents_view.php?site_id=qba&TREE_NO=16596&DEPTH=2">
					...
					<div class="main-contents02">
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="3312";
														$boardList = BBS_GetList("bbs_qba", $bbs_no, 0, 5, 300);
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="3312";
														$boardList = BBS_GetList("bbs_qba", $bbs_no, 0, 5, 300, 0, "1학년");
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="3312";
														$boardList = BBS_GetList("bbs_qba", $bbs_no, 0, 5, 300, 0, "2학년");
                                ...
                                <div class="video-gallery-wrapper">
                                    ...
                                    <div class="video-gallery-area">
										<?php
                                        $bbs_no="3315";
                                        $boardList = BBS_GetList("bbs_qba", $bbs_no, 1, 2, 300, 0, "");
                                        foreach ( $boardList as $k => $v ) {
                                        ?>
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/schedule/list.php?site_id=qba&TREE_NO=16598&DEPTH=2">
									...
									<li>
										<a href="/contents/contents_view.php?site_id=qba&TREE_NO=16589&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=qba&TREE_NO=16603&DEPTH=2">
											<span class="image center-crop">
					...
					<div class="main-contents03">
						<div class="main-contents-wrapper">
							<div class="main-news-wrapper">
								...
								<a href="/board/board.php?site_id=qba&TREE_NO=16600&DEPTH=2" class="btn-more" title="학과뉴스 더보기">
