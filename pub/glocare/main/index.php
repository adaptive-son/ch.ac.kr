				...
				<article>
					<div class="main-contents01" id="contents">
										...
										<div class="swiper-slide">
											...
											<div class="main-slogan-wrapper01">
												...
												<dl>
													...
													<dd>
														<span>글로벌케어과는 외국인 유학생과 결혼 이주자를 대상으로</span>
						...
						<div class="main-menu01-wrapper">
							...
							<div class="main-menu01-area">
								<a href="/contents/contents_view.php?site_id=glocare&TREE_NO=16446&DEPTH=2">
							...
							<div class="main-menu01-area">
								<a href="/contents/contents_view.php?site_id=glocare&TREE_NO=16454&DEPTH=2">
							...
							<div class="main-menu01-area">
								<a href="/contents/contents_view.php?site_id=glocare&TREE_NO=16452&DEPTH=2">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													...
													<?php
														...
														$bbs_no="3010";
														$boardList = BBS_GetList("bbs_glocare", $bbs_no, 0, 5, 300);
														...
														<li>
															<a href="<?php echo $view_linkUrl?>&data=<?=$v['linkdata']?>">
																<span class="title-area">
																	...
																	<!--<img src="../img/icon/icon_new@2x.png" alt="NEW" />-->
																</span>
																<span class="date">
																	<?php echo $v['datetime']?>
																</span>
													...
													<a href="/board/board.php?site_id=glocare&TREE_NO=16436&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="3010";
														$boardList = BBS_GetList("bbs_glocare", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=glocare&TREE_NO=16436&DEPTH=2&category=1학년" class="btn-more" title="공지사항 더보기">
														<img src="../img/main/icon_more01.gif" alt="">
													</a>
												</div>
											</li>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="3010";
														$boardList = BBS_GetList("bbs_glocare", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=glocare&TREE_NO=16436&DEPTH=2&category=2학년" class="btn-more" title="공지사항 더보기">
														<img src="../img/main/icon_more01.gif" alt="">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
                                    ...
                                    <div class="video-gallery-area">
										<?php
										$bbs_no="3012";
										$boardList = BBS_GetList("bbs_glocare", $bbs_no, 1, 2, 300, 0, "");
										$sql_BoardInfomation = " SELECT TREE_NO, DEPTH FROM ".TABLE_TREE." WHERE CONTENTS LIKE '%".$bbs_no."%' and TREE_ID = '".site_id."' ";
										$row_BoardTreeInfo = $adb->getRow($sql_BoardInfomation, DB_FETCHMODE_ASSOC);
										$param_menuInfo = "site_id=".site_id."&TREE_NO=".$row_BoardTreeInfo[TREE_NO]."&DEPTH=".($row_BoardTreeInfo[DEPTH]+1);
										$more_linkUrl = "/board/board.php?".$param_menuInfo;
