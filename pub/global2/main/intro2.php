		...
		<div class="intro-area">
			...
			<h1>
				<a href="/main/index.php" class="intro-logo">
					<strong class="intro-logo-text">춘해보건대학교 국제교류처</strong>
				</a>
			</h1>
			...
			<div class="intro-cards">
				...
				<div class="intro-card card--blue">
					<div class="card-head">
						<strong class="card-title"><a href="/main/index.php">국제교류처</a></strong>
				...
				<div class="intro-card card--teal">
					<div class="card-head">
						<strong class="card-title"><a href="<?=$find_2depth[16627][LINK_URL]?>">한국어교육센터</a></strong>
				...
				<div class="intro-card card--sky">
					<div class="card-head">
						<strong class="card-title"><a href="#">글로벌센터</a></strong>
						<span class="card-title-en">Global Center</span>
					</div>
					<div class="card-body">
						<ul class="card-menu">
							<li><a href="#">글로벌센터 소개</a></li>
							<li><a href="#">영어 교육</a></li>
							<li><a href="#">해외 연수</a></li>
							<li><a href="#">글로벌 현장학습</a></li>
							<li><a href="#">공지사항</a></li>
							<li><a href="#">FAQ</a></li>
				...
				<div class="intro-card card--purple">
					<div class="card-head">
						<strong class="card-title"><a href="#">국제개발협력센터</a></strong>
						<span class="card-title-en">International Development Cooperation Center</span>
					</div>
					<div class="card-body">
						<ul class="card-menu">
							<li><a href="#">국제개발협력센터 소개</a></li>
							<li><a href="#">코이카 중점 사업</a></li>
							<li><a href="#">개발협력사업</a></li>
							<li><a href="#">공지사항</a></li>
							<li><a href="#">FAQ</a></li>
							<li><a href="#">포토갤러리</a></li>
							<li><a href="#">자료실</a></li>							
