			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Yoga 신체적 정신적 건강관리 전문가 양성, 요가의 이론적 체계와 실제 수련과정을 교과목으로 편성, 신체적, 심리적, 정신적, 영적 건강을 통합하여 전인건강 증진을 위한 건강관리 전문가 양성을 목표로 합니다.">
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=yoga&TREE_NO=15849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=yoga&TREE_NO=15861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=yoga&TREE_NO=15862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="2310";
														$boardList = BBS_GetList("bbs_yoga", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=yoga&TREE_NO=15863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2310";
														$boardList = BBS_GetList("bbs_yoga", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=yoga&TREE_NO=15863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2310";
														$boardList = BBS_GetList("bbs_yoga", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=yoga&TREE_NO=15863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="2321";
										$boardList = BBS_GetList("bbs_yoga", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										...
										<li>
											<a href="https://blog.naver.com/cyoga2016" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_blog01.png" alt="BLOG" />
											</a>
										</li>

										<li>
											<a href="https://www.youtube.com/@user-qn1hn6fl2h" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>

										<li>
											<a href="https://instagram.com/choonhaeyoga?igshid=NTc4MTIwNjQ2YQ==" target="_blank" title="새창열림">
								...
								<div class="main-movie-wrapper">
									<a href="https://www.youtube.com/watch?v=ahJGf8fxcnY" class="main-movie-area">
										<h3>
											<span class="title">
												<strong>
													학과동영상
							...
							<div class="main-menu02">
								<ul>
									...
									<li>
										<a href="/contents/contents_view.php?site_id=yoga&TREE_NO=16458&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=yoga&TREE_NO=15869&DEPTH=2">
											<span class="image center-crop">
