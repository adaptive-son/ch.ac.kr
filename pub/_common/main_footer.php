			<!--
			// 대학 메인 내 모든 페이지에 적용 확인 2024.02.15
			-->
            <div class="footer">
				<div class="footer-wrapper">
					<div class="footer-select-wrapper">
						<dl>
							...
							<dd class="selected-list01">
								<ul>
									<li>
										<strong>4년제 학부</strong>
										<ul>
											<li><a href="https://nurs.ch.ac.kr" target="_blank" title="새창열림_간호학부">간호학부</a></li>
										</ul>
									</li>
									...
									<li>
										...
										<ul>
											<li>
												<a href="https://dent.ch.ac.kr" target="_blank" title="새창열림_간호학과">치위생과</a>
											</li>
											<li>
											...
											<li>
												<a href="https://pt.ch.ac.kr/" target="_blank" title="새창열림_물리치료과">물리치료과</a>
											</li>
											<li>
					...
					<div class="footer-left-wrapper">
						<ul>
							<li>
								<a href="/contents/contents_view.php?site_id=main&TREE_NO=16214&DEPTH=2" class="word-privacy">
									개인정보처리방침
								</a>
							</li>
							<li>
							...
							<li>
								<a href="https://ch.ac.kr/information/sub/sub01_01.php" target="_blank" title="새창 열림">
									정보공개
								</a>
							</li>
							<li>
								<a href="/contents/contents_view.php?site_id=main&TREE_NO=16223&DEPTH=2">
									이메일무단수집거부
								</a>
							</li>
							<li>
								<a href="/file/2024_choonhae_college.pdf" target="_blank" title="새창 열림">
									대학자체평가
								</a>
							</li>
							<li>
								<a href="https://www.academyinfo.go.kr/pubinfo/pubinfo1600/doInit.do?schlId=0000545" target="_blank" title="새창 열림">
									대학정보공시
								</a>
							</li>
							<li>
								<a href="/board/board.php?site_id=main&TREE_NO=16066&DEPTH=2" title="업무추진비 이동">
									업무추진비
								</a>
							</li>
							<li>
								<a href="/adm/" title="관리자모드">
									관리자모드
								</a>
							</li>							
						</ul>
					...
					<a href="#none" class="btn-footer-top-go">
						<img src="/_common/img02/common/icon_arrow_up04.png" alt="상단으로 이동">
					</a>
					<!--<a href="https://www.wa.or.kr/board/list.asp?BoardID=0006" title="새창 열림" target="_blank" class="mark-wa">
						<img src="/_common/img02/common/mark_wa01.png" alt="(사)한국장애인단체총연합회􀀁 한국웹접근성인증평가원􀀁 웹􀀁 접근성 우수사이트􀀁 인증마크(WA인증마크)" />
					</a>-->
				</div>
				...
				<a href="javascript:history.back(-1)" class="btn-mobile-back" title="뒤로 이동">
					BACK
				</a>
				<!-- //상단으로 이동 -->
			</div>