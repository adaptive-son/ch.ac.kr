			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Dental Hygiene 전인적 인성을 갖춘 치과위생사 양성, 국민의 구강건강을 향상시키기 위한 전문기술을 가진 우수한 치과위생사를 양성하며 산학협동을 통해 현장실무중심 교육으로 유능한 치과위생사를 배출하고 있습니다.">
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=dent&TREE_NO=6849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=dent&TREE_NO=6861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=dent&TREE_NO=6862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="1310";
														$boardList = BBS_GetList("bbs_dent", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=dent&TREE_NO=6863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1310";
														$boardList = BBS_GetList("bbs_dent", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=dent&TREE_NO=6863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1310";
														$boardList = BBS_GetList("bbs_dent", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=dent&TREE_NO=6863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1310";
														$boardList = BBS_GetList("bbs_dent", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=dent&TREE_NO=6863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1310";
														$boardList = BBS_GetList("bbs_dent", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=dent&TREE_NO=6863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="1323";
										$boardList = BBS_GetList("bbs_dent", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="http://pf.kakao.com/_RLwdK" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_kakaotalk01.png" alt="KAKAOTALK" />
											</a>
										</li>
										<li>
											<a href="https://www.facebook.com/profile.php?id=100077598576131&mibextid=LQQJ4d" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://www.youtube.com/channel/UCHAhP4y9FCjyTcyjvqo6pug" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>

										<li>
											<a href="https://instagram.com/ch_dental_hygienist?igshid=OGQ5ZDc2ODk2ZA" target="_blank" title="새창열림">
								...
								<div class="main-movie-wrapper">
									<a href="https://www.youtube.com/watch?v=_nKwMvPcVsM" target="_blank" class="main-movie-area">
										<div class="main-movie-box">
											<img src="../img/main/img_movie03.jpg" alt="" class="bg"/>
								...
								<a href="https://www.youtube.com/watch?v=17sx4sBnc9k" target="_blank" class="main-movie-area2">
									<div class="main-movie-box">
										<img src="../img/main/img_movie04.jpg" alt="" class="bg"/>
										<img src="../img/main/btn_play.png" alt="" class="icon-movie"/>
									</div>
								</a>
								</div>
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/board/board.php?site_id=dent&TREE_NO=6865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=dent&TREE_NO=6850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=dent&TREE_NO=6869&DEPTH=2">
											<span class="image center-crop">
					...
					<div class="main-contents03">
						<div class="main-contents-wrapper">
							...
							<ul class="main-sns-list">
								...
								<li>
									<a href="https://www.facebook.com/people/%EC%B6%98%ED%95%B4%EB%B3%B4%EA%B1%B4%EB%8C%80%ED%95%99%EA%B5%90-%EC%B9%98%EC%9C%84%EC%83%9D%EA%B3%BC/100077598576131/" target="_blank" title="새창열림">
										<img src="../../_common/img/icon/icon_facebook01.png" alt="FACEBOOK" />
									</a>
								</li>
								...
								<li>
									<a href="https://www.instagram.com/ch_dental_hygienist/?hl=ko" target="_blank" title="새창열림">
										<img src="../../_common/img/icon/icon_instagram01.png" alt="INSTAGRAM" />
									</a>
								</li>
							</ul>
