				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							<img src="../img/main/main_visual_pc02.jpg" alt="메인이미지" class="pc"/>
							<img src="../img/main/main_visual_mobile02.jpg" alt="메인이미지" class="mobile"/>
							
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan02.png" alt="Department of Social Welfare Care 삶의 질 향상을 위한 사회복지 전문가 양성, 사회복지에 관한 다양한 이론과 기술교육을 통하여 국민의 삶의 질 향상에 기여할 수 있는 사회복지전문인과 케어전문지식과 기술을 가진 케어복지사를 양성하고 있습니다." />
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=welf&TREE_NO=14849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=welf&TREE_NO=14861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=welf&TREE_NO=14862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="2210";
														$boardList = BBS_GetList("bbs_welf", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=welf&TREE_NO=14863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2210";
														$boardList = BBS_GetList("bbs_welf", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=welf&TREE_NO=14863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2210";
														$boardList = BBS_GetList("bbs_welf", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=welf&TREE_NO=14863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2210";
														$boardList = BBS_GetList("bbs_welf", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=welf&TREE_NO=14863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="2223";
										$boardList = BBS_GetList("bbs_welf", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="http://pf.kakao.com/_XExndK" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://www.instagram.com/choonhae__sw?igsh=MTMycWwxM2ozZHpzbw==" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/schedule/list.php?site_id=welf&TREE_NO=14865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=welf&TREE_NO=14850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=welf&TREE_NO=14869&DEPTH=2">
											<span class="image center-crop">
