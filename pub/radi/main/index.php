...
if ($_SERVER['REMOTE_ADDR']=="112.217.216.250"){ 
				...
				//echo "<img src='https://radi.ch.ac.kr/data/bbs_upload/upfile_data/2020-09/2020-09-03/1599107593c0e5704ffed5f575335636128620ef7f.jpg' onerror=''>";
				//exit;
			}
?>
			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Radiological Technology 임상실무중심의 실무형 방사선사 양성,  X-ray, MRI, CT, 초음파 등 첨단장비를 이용한 영상의학을 통한 질병 진단 및 방사선 치료, 핵의학 분야의 전문의료 기술 인력인 방사선사를 양성하는 학과입니다." />
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=radi&TREE_NO=10849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=radi&TREE_NO=10861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=radi&TREE_NO=10862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="1710";
														$boardList = BBS_GetList("bbs_radi", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=radi&TREE_NO=10863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1710";
														$boardList = BBS_GetList("bbs_radi", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=radi&TREE_NO=10863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1710";
														$boardList = BBS_GetList("bbs_radi", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=radi&TREE_NO=10863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1710";
														$boardList = BBS_GetList("bbs_radi", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=radi&TREE_NO=10863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="1710";
														$boardList = BBS_GetList("bbs_radi", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=radi&TREE_NO=10863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="1723";
										$boardList = BBS_GetList("bbs_radi", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="https://open.kakao.com/o/sqjOJ3df" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://instagram.com/choonhae_rd?igshid=YmM0MjE2YWMzOA==" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/schedule/list.php?site_id=radi&TREE_NO=10865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=radi&TREE_NO=10850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=radi&TREE_NO=10869&DEPTH=2">
											<span class="image center-crop">
