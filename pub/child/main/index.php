			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Childhood Education 미래 교육을 선도할 영유아 교사 양성, 유아교육과는 예비교사로서 전문성을 함양하기 위하여 체계적인 전공 수업을 실시하고, 지역 유치원 및 어린이집에서 다양한 실습을 하고 있습니다." />
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=child&TREE_NO=12849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=child&TREE_NO=12861&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=child&TREE_NO=12862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="2010";
														$boardList = BBS_GetList("bbs_child", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=child&TREE_NO=12863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2010";
														$boardList = BBS_GetList("bbs_child", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=child&TREE_NO=12863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2010";
														$boardList = BBS_GetList("bbs_child", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=child&TREE_NO=12863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2010";
														$boardList = BBS_GetList("bbs_child", $bbs_no, 0, 5, 300, 0, "3학년");
													...
													<a href="/board/board.php?site_id=child&TREE_NO=12863&DEPTH=2&category=3학년" class="btn-more" title="3학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2010";
														$boardList = BBS_GetList("bbs_child", $bbs_no, 0, 5, 300, 0, "전공심화과정");
													...
													<a href="/board/board.php?site_id=child&TREE_NO=12863&DEPTH=2&category=전공심화과정" class="btn-more" title="전공심화과정 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="2024";
										$boardList = BBS_GetList("bbs_child", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="https://pf.kakao.com/_lZxndK" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://www.youtube.com/channel/UCkxHBkYESwYV7ACNZUw-7Vw" target="_blank" title="새창열림">
												<img src="../../_common/img/icon/icon_youtube01.png" alt="YOUTUBE" />
											</a>
										</li>
										<li>
											<a href="https://www.instagram.com/chchild2010_new" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/schedule/list.php?site_id=child&TREE_NO=12865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=child&TREE_NO=12850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=child&TREE_NO=12869&DEPTH=2">
											<span class="image center-crop">
