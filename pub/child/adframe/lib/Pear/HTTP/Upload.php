 ...
 * for file uploads made from page forms
 *
 * @author  Tomas V.V.Cox <cox@idecnet.com>
 * @see http://vulcanonet.com/soft/index.php?pack=uploader
 * @package  HTTP_Upload
...
class HTTP_Upload_File extends HTTP_Upload_Error
{
    ...
    /**
     * It's a common security risk in page who has the upload dir
    ...
    /**
     * Unique file names in the form: 9022210413b75410c28bef.page
