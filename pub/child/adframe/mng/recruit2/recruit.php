    ...
    <div align="left">
        ...
        <table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#EEEEEE>
            <form name=fboardlist method=post>
                ...
                $Obj=new PList("/adframe/mng/recruit2/recruit.php",$pagecnt,$offset,$numrows,$PAGEBLOCK,$LIMIT,$search,$searchstring,"resume_gubun=".$resume_gubun."");
