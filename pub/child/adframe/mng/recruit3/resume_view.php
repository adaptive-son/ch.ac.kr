...
if($wr_id != ""){
    $sql = " select * from recruit_te_copy where wr_id = '$wr_id' ";
    $row = mysql_fetch_array(mysql_query($sql));

    $date = mysql_fetch_array(mysql_query("select * from recruit_te WHERE parent='$row[wr_id]'"));

    $school_addr = mysql_fetch_array(mysql_query("SELECT * FROM recruit_te_school_addr WHERe parent='$row[wr_id]'"));
}
?>
