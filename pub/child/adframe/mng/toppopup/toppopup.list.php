...
$sql = " select * from ".TABLE_TOPPOPUP." where no > 0 AND site_id='$_SESSION[sel_site_id]' ".$search_qry;
$rs = $adb->query($sql);
// 총 레코드 수
$numrows = $rs->numRows();
                        ...
                        <table class="table table-hover" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?=TOPPOPUP_LOAD_PATH?>/<?= $pg_row[toppopup_name] ?>" style="height: 100px; width: auto; max-width: 200px;">
                                    </td>
                                    <td>
