...
$sql = " select * from ".TABLE_MEMBER." where del_yn='N' AND idx > 0 ".$search_qry;
            ...
            <fieldset>
                ...
                <div class="btns-area">
                    <div class="btns-right">
                        <a href="user.add.php" class="btn-type01">
                            추가
                        </a>
                    </div>
                </div>
                ...
                <div class="board-list">
                    <table style="width: 100%" summary="이 표는 게시판에 대해 목록정보를 제공하는 표입니다.">
                        ...
                        <tr>
                            <?
                            $arr_title = array("번호","아이디", "이름", "유형", "등록일", "수정일", "관리");
                        ...
                        <? if ( $numrows == 0 ) { ?>
                            ...
                            $sql .= " order by idx asc limit ".$offset.", ".$LIMIT;
                            ...
                            for ( $i = 0 ; $pg_row = $pg_result->fetchRow() ; $i++ ) {
                                ...
                                <tr>
                                    ...
                                    <td><?=$pg_row[id]?></td>
                                    <td><?=$pg_row[name]?></td>
                                    <td><?=get_code_detail('MEMBER_TYPE',$pg_row[user_type])?></td>
                                    <td>
                                        <?=$pg_row[regi_date]?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="user.add.php?mode=u&idx=<?= $pg_row[idx]?>&id=<?= $pg_row[id]?>"><img src="../make_img/board/btn_modify.gif" align="absmiddle" alt="수정"></a>
                                        <a href="javascript:del('user.proc.php?mode=d&id=<?=$pg_row[id]?>')"><img src="../make_img/board/btn_delete.gif" align="absmiddle" alt="삭제"></a>
                                    </td>
                                </tr>
                                <? $letter_no--; } } ?>
                        </tbody>
