...
// 개인정보 접근로그
if ( $pgidx > 0 ) log_Access_ForPrivate("recruit-appinfo-pinrt3");
if($wr_id != ""){
    $sql1 = " select * from recruit_copy where wr_id = '$wr_id' ";
    $data1 = mysql_fetch_array(mysql_query($sql1));
    $date = mysql_fetch_array(mysql_query("select * from recruit1 WHERE parent='$wr_id'"));
}
?>
...
<table class="table_box_recruit" style="margin:10px 0px;">
	...
	<tr>
        <td>지도 교수 및 논문심사 위원</td>
        <td colspan="4" class="left"><?=$date[thesis1_tutor]?></td>
    </tr>
    <tr>
        <td>제목</td>
	...
	<tr>
        <td>지도 교수 및 논문심사 위원</td>
        <td colspan="4" class="left"><?=$date[thesis2_tutor]?></td>
    </tr>
    <tr>
        <td>제목</td>
...
<table class="table_box_recruit" style="margin-top:-10px;">
    ...
    <?if($date[study8_gubun]){?>
        <tr>
            ...
            <td><?=$date[study8_author]?></td>
        </tr>
    <?}?>
    <?if($date[study9_gubun]){?>
        <tr>
            <td><?
                if($date[study9_gubun]=="1") echo "국내학술지 논문";
                if($date[study9_gubun]=="2") echo "국외학술지 논문";
                if($date[study9_gubun]=="3") echo "학술저서";
                if($date[study9_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study9_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study9_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study9_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study9_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study9_content])?></td-->
            <td><?=$date[study9_date]?></td>
			<td><?=$date[study9_book]?></td>
            <td><?=$date[study9_mem]?></td>
            <td><?=$date[study9_author]?></td>
        </tr>
    <?}?>
    <?if($date[study10_gubun]){?>
        <tr>
            <td><?
                if($date[study10_gubun]=="1") echo "국내학술지 논문";
                if($date[study10_gubun]=="2") echo "국외학술지 논문";
                if($date[study10_gubun]=="3") echo "학술저서";
                if($date[study10_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study10_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study10_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study10_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study10_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study10_content])?></td-->
            <td><?=$date[study10_date]?></td>
			<td><?=$date[study10_book]?></td>
            <td><?=$date[study10_mem]?></td>
            <td><?=$date[study10_author]?></td>
        </tr>
    <?}?>
    <?if($date[study11_gubun]){?>
        <tr>
            <td><?
                if($date[study11_gubun]=="1") echo "국내학술지 논문";
                if($date[study11_gubun]=="2") echo "국외학술지 논문";
                if($date[study11_gubun]=="3") echo "학술저서";
                if($date[study11_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study11_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study11_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study11_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study11_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study11_content])?></td-->
            <td><?=$date[study11_date]?></td>
			<td><?=$date[study11_book]?></td>
            <td><?=$date[study11_mem]?></td>
            <td><?=$date[study11_author]?></td>
        </tr>
    <?}?>
    <?if($date[study12_gubun]){?>
        <tr>
            <td><?
                if($date[study12_gubun]=="1") echo "국내학술지 논문";
                if($date[study12_gubun]=="2") echo "국외학술지 논문";
                if($date[study12_gubun]=="3") echo "학술저서";
                if($date[study12_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study12_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study12_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study12_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study12_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study12_content])?></td-->
            <td><?=$date[study12_date]?></td>
			<td><?=$date[study12_book]?></td>
            <td><?=$date[study12_mem]?></td>
            <td><?=$date[study12_author]?></td>
        </tr>
    <?}?>
    <?if($date[study13_gubun]){?>
        <tr>
            <td><?
                if($date[study13_gubun]=="1") echo "국내학술지 논문";
                if($date[study13_gubun]=="2") echo "국외학술지 논문";
                if($date[study13_gubun]=="3") echo "학술저서";
                if($date[study13_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study13_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study13_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study13_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study13_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study13_content])?></td-->
            <td><?=$date[study13_date]?></td>
			<td><?=$date[study13_book]?></td>
            <td><?=$date[study13_mem]?></td>
            <td><?=$date[study13_author]?></td>
        </tr>
    <?}?>
    <?if($date[study14_gubun]){?>
        <tr>
            <td><?
                if($date[study14_gubun]=="1") echo "국내학술지 논문";
                if($date[study14_gubun]=="2") echo "국외학술지 논문";
                if($date[study14_gubun]=="3") echo "학술저서";
                if($date[study14_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study14_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study14_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study14_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study14_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study14_content])?></td-->
            <td><?=$date[study14_date]?></td>
			<td><?=$date[study14_book]?></td>
            <td><?=$date[study14_mem]?></td>
            <td><?=$date[study14_author]?></td>
        </tr>
    <?}?>
    <?if($date[study15_gubun]){?>
        <tr>
            <td><?
                if($date[study15_gubun]=="1") echo "국내학술지 논문";
                if($date[study15_gubun]=="2") echo "국외학술지 논문";
                if($date[study15_gubun]=="3") echo "학술저서";
                if($date[study15_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study15_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study15_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study15_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study15_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study15_content])?></td-->
            <td><?=$date[study15_date]?></td>
			<td><?=$date[study15_book]?></td>
            <td><?=$date[study15_mem]?></td>
            <td><?=$date[study15_author]?></td>
        </tr>
    <?}?>
    <?if($date[study16_gubun]){?>
        <tr>
            <td><?
                if($date[study16_gubun]=="1") echo "국내학술지 논문";
                if($date[study16_gubun]=="2") echo "국외학술지 논문";
                if($date[study16_gubun]=="3") echo "학술저서";
                if($date[study16_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study16_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study16_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study16_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study16_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study16_content])?></td-->
            <td><?=$date[study16_date]?></td>
			<td><?=$date[study16_book]?></td>
            <td><?=$date[study16_mem]?></td>
            <td><?=$date[study16_author]?></td>
        </tr>
    <?}?>
    <?if($date[study17_gubun]){?>
        <tr>
            <td><?
                if($date[study17_gubun]=="1") echo "국내학술지 논문";
                if($date[study17_gubun]=="2") echo "국외학술지 논문";
                if($date[study17_gubun]=="3") echo "학술저서";
                if($date[study17_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study17_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study17_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study17_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study17_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study17_content])?></td-->
            <td><?=$date[study17_date]?></td>
			<td><?=$date[study17_book]?></td>
            <td><?=$date[study17_mem]?></td>
            <td><?=$date[study17_author]?></td>
        </tr>
    <?}?>
    <?if($date[study18_gubun]){?>
        <tr>
            <td><?
                if($date[study18_gubun]=="1") echo "국내학술지 논문";
                if($date[study18_gubun]=="2") echo "국외학술지 논문";
                if($date[study18_gubun]=="3") echo "학술저서";
                if($date[study18_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study18_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study18_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study18_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study18_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study18_content])?></td-->
            <td><?=$date[study18_date]?></td>
			<td><?=$date[study18_book]?></td>
            <td><?=$date[study18_mem]?></td>
            <td><?=$date[study18_author]?></td>
        </tr>
    <?}?>
    <?if($date[study19_gubun]){?>
        <tr>
            <td><?
                if($date[study19_gubun]=="1") echo "국내학술지 논문";
                if($date[study19_gubun]=="2") echo "국외학술지 논문";
                if($date[study19_gubun]=="3") echo "학술저서";
                if($date[study19_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study19_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study19_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study19_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study19_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study19_content])?></td-->
            <td><?=$date[study19_date]?></td>
			<td><?=$date[study19_book]?></td>
            <td><?=$date[study19_mem]?></td>
            <td><?=$date[study19_author]?></td>
        </tr>
    <?}?>
    <?if($date[study20_gubun]){?>

        <tr>
            <td><?
                if($date[study20_gubun]=="1") echo "국내학술지 논문";
                if($date[study20_gubun]=="2") echo "국외학술지 논문";
                if($date[study20_gubun]=="3") echo "학술저서";
                if($date[study20_gubun]=="4") echo "국내 학술대회 발표";
                if($date[study20_gubun]=="5") echo "국외 학술대회 발표";
                if($date[study20_gubun]=="6") echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";
                if($date[study20_gubun]=="7") echo "기타";
                ?></td>
            <td><?=$date[study20_subject]?></td>
            <!--td><?=str_replace('\\','',$date[study20_content])?></td-->
            <td><?=$date[study20_date]?></td>
			<td><?=$date[study20_book]?></td>
            <td><?=$date[study20_mem]?></td>
            <td><?=$date[study20_author]?></td>
        </tr>
    <?}?>
</table>
