...
<table class="table_box_recruit" style="margin:10px 0px;">
    ...
    <tr>
        <td>논문개요</td>
        <td colspan="5" class="left"><?=nl2br($date[thesis1_content])?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>논문개요</td>
        <td colspan="5" class="left"><?=nl2br($date[thesis2_content])?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <?
            if($date['study'.$i.'_gubun']=="1"){echo "국내학술지 논문";}
            elseif($date['study'.$i.'_gubun'=="2"]){echo "국외학술지 논문";}
            elseif($date['study'.$i.'_gubun'=="3"]){echo "학술저서";}
            elseif($date['study'.$i.'_gubun'=="4"]){echo "국내 학술대회 발표";}
            elseif($date['study'.$i.'_gubun'=="5"]){echo "국외 학술대회 발표";}
            elseif($date['study'.$i.'_gubun'=="6"]){echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문";}
            elseif($date['study'.$i.'_gubun'=="7"]){echo "기타";}
            ?>
        </td>
        <td ><?=$date['study'.$i.'_subject']?></td>
        <td class="left"><?=nl2br($date['study'.$i.'_content'])?></td>
    ...
    <tr>
        <td>
          <?
		switch($date["study".$i."_gubun"]) {
			case 1: echo "국내학술지 논문"; break;
			case 2: echo "국외학술지 논문"; break;
			case 3: echo "학술저서"; break;
			case 4: echo "국내 학술대회 발표"; break;
			case 5: echo "국외 학술대회 발표"; break;
			case 6: echo "국제적 저명학술지(SCI, SSCI, A&HCI) 등재 논문"; break;
			case 7: echo "기타"; break;
			default: break;
		}
		/*
          if($date['study'.$i.'_gubun']=="1"){echo "국내학술지 논문";}
