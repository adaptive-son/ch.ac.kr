						...
						<dd>
                            ...
                            <div class="input-period-wrapper">
                                <div class="input-period-area">
                                    <input type="text" id="notice_start" name="fm_notice_start" class="sdate datepicker" value="" size="15" maxlength="10" readonly="readonly" title="공지 개시 시작">
                                </div>
                                <span class="word-unit">~</span>
                                <div class="input-period-area">
                                    <input type="text" id="notice_end" name="fm_notice_end" class="edate datepicker" readonly="readonly" title="공지 개시 마감">
                                </div>
                            </div>
						</dd>
					</dl>
...
<?php
if($configBBS['module_editor']=="ckeditor"){?>
<script>
	//객체 생성
	var ajaxImage = {};
