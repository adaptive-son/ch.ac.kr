...
<div class="board-area">
    ...
    <div class="board-view">
        ...
        <div class="board-contents">
            ...
            ?>
			<? if($view_row[etc_char1]!=""){?>
			<div class="moview-wrapper">
				<iframe src="https://www.youtube.com/embed/<?=$view_row[etc_char1]?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
            <?}?>
			<?php
			//첨부파일 중 PDF 파일이 있으면 바로 노출
if(site_id=="dent" && $TREE_NO == '6863'){ //치위생과 공지사항
			if ( $filev > 0 ) { 
				for ( $i = 0 ; $i < $filev; $i++ ) {
    ...
    <ul class="board-view-sns">
        ...
        <li>
            <a href="#none" onclick="fn_copy_url()" title="새창 열림">
