			...
			<div class="main-container" id="container">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							...
							<p class="main-slogan-wrapper">
								<img src="../img/main/word_main_slogan01.png" alt="Department of Health and Medical Convergence 병원행정 전문가 의료기기 전문가, 춘해보건대학교 보건의료융합계열은 보건과 의학, 공합을 융·복합하여 보건의료산업에서 요구하는 실무형 인재를 양성하고 있습니다.">
							</p>
						</p>
					</div>
					...
					<div class="main-menu01-wrapper">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=hadm&TREE_NO=13849&DEPTH=2">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=hadm&TREE_NO=15872&DEPTH=3">
						...
						<div class="main-menu01-area">
							<a href="/contents/contents_view.php?site_id=hadm&TREE_NO=13862&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														$bbs_no="2110";
														$boardList = BBS_GetList("bbs_hadm", $bbs_no, 0, 5, 300);
													...
													<a href="/board/board.php?site_id=hadm&TREE_NO=13863&DEPTH=2" class="btn-more" title="공지사항 더보기">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2110";
														$boardList = BBS_GetList("bbs_hadm", $bbs_no, 0, 5, 300, 0, "1학년");
													...
													<a href="/board/board.php?site_id=hadm&TREE_NO=13863&DEPTH=2&category=1학년" class="btn-more" title="1학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
														...
														// (테이블명, 코드, 보드타입, 게시물수, 내용글수)
														$bbs_no="2110";
														$boardList = BBS_GetList("bbs_hadm", $bbs_no, 0, 5, 300, 0, "2학년");
													...
													<a href="/board/board.php?site_id=hadm&TREE_NO=13863&DEPTH=2&category=2학년" class="btn-more" title="2학년 더보기">
														<img src="../img/main/icon_more01.gif">
													</a>
												</div>
											</li>
                                ...
                                <div class="video-gallery-wrapper">
									...
									<?php
										$bbs_no="2122";
										$boardList = BBS_GetList("bbs_hadm", $bbs_no, 1, 2, 300, 0, "");
										foreach ( $boardList as $k => $v ) {
									...
									<ul class="main-sns-list">
										<li>
											<a href="http://pf.kakao.com/_qxiwdK" target="_blank" title="새창열림">
										...
										<li>
											<a href="https://instagram.com/choonhae__?igshid=YzcxN2Q2NzY0OA==" target="_blank" title="새창열림">
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="/board/board.php?site_id=hadm&TREE_NO=13865&DEPTH=2">
									...
									<li>
										<a href="/board/board.php?site_id=hadm&TREE_NO=13850&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="/board/board.php?site_id=hadm&TREE_NO=13869&DEPTH=2">
											<span class="image center-crop">
