...
<head>
	...
	<link rel="stylesheet" href="../css/main_2024.08.24.css">
				...
				<article>
					<div class="main-contents01" id="contents">
						<div class="main-visual-wrapper">
							<div class="main-visual-slider-wrapper">
								<div class="main-slogan-wrapper01">
									<p class="word-eng">
										Forest &amp; Landscape Architecture Business
									</p>
									<dl>
										<dt>
											<span>글로컬 산림&middot;조경</span>
											<span>전문가 양성</span>
										</dt>
										<dd>
											<span>울산 유일의 산림&middot;조경 전문가 양성 학과로 졸업과 동시에 산림&middot;조경 </span>
											<span>관련 자격증 취득을 통해 다양한 산림&middot;조경 분야에 취업이 가능하여 </span>
											<span>평생직업이 보장된 학과입니다</span>
										</dd>
									</dl>
								</div>
								<div class="swiper-container" id="main-visual-slider">
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide">
											<img src="../img/main/main_visual_pc04.jpg" alt="" class="pc"/>
											<img src="../img/main/main_visual_mobile04.jpg" alt="" class="mobile"/>
										</div>
									</div>
								</div>
						...
						<div class="main-menu01-wrapper">
							...
							<div class="main-menu01-area">
								<a href="https://flab.ch.ac.kr/contents/contents_view.php?site_id=flab&TREE_NO=16302&DEPTH=2">
							...
							<div class="main-menu01-area">
								<a href="https://flab.ch.ac.kr/contents/contents_view.php?site_id=flab&TREE_NO=16322&DEPTH=2">
							...
							<div class="main-menu01-area">
								<a href="https://flab.ch.ac.kr/contents/contents_view.php?site_id=flab&TREE_NO=16320&DEPTH=2">
						...
						<div class="main-contents-wrapper">
							...
							<div class="main-contents-area">
								...
								<div class="main-board-wrapper">
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
                                                        ...
                                                        $bbs_no="2810";
                                                        $boardList = BBS_GetList("bbs_flab", $bbs_no, 0, 5, 300);
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
                                                        ...
                                                        // (테이블명, 코드, 보드타입, 게시물수, 내용글수)
                                                        $bbs_no="2810";
                                                        $boardList = BBS_GetList("bbs_flab", $bbs_no, 0, 5, 300, 0, "1학년");
                                                        // 게시판 메뉴 정보 가져오기
                                                        $sql_BoardInfomation = " SELECT TREE_NO, DEPTH FROM ".TABLE_TREE." WHERE CONTENTS LIKE '%".$bbs_no."%' and TREE_ID = '".site_id."' ";
                                                        $row_BoardTreeInfo = $adb->getRow($sql_BoardInfomation, DB_FETCHMODE_ASSOC);
                                                        $param_menuInfo = "site_id=".site_id."&TREE_NO=".$row_BoardTreeInfo[TREE_NO]."&DEPTH=".($row_BoardTreeInfo[DEPTH]+1);
											...
											<li>
												...
												<div class="main-board-box">
													<ul>
                                                        ...
                                                        // (테이블명, 코드, 보드타입, 게시물수, 내용글수)
                                                        $bbs_no="2810";
                                                        $boardList = BBS_GetList("bbs_flab", $bbs_no, 0, 5, 300, 0, "2학년");
                                                        // 게시판 메뉴 정보 가져오기
                                                        $sql_BoardInfomation = " SELECT TREE_NO, DEPTH FROM ".TABLE_TREE." WHERE CONTENTS LIKE '%".$bbs_no."%' and TREE_ID = '".site_id."' ";
                                                        $row_BoardTreeInfo = $adb->getRow($sql_BoardInfomation, DB_FETCHMODE_ASSOC);
                                                        $param_menuInfo = "site_id=".site_id."&TREE_NO=".$row_BoardTreeInfo[TREE_NO]."&DEPTH=".($row_BoardTreeInfo[DEPTH]+1);
											...
											<!--li>
												...
												<div class="main-board-box">
													<ul>
                                                        ...
                                                        // (테이블명, 코드, 보드타입, 게시물수, 내용글수)
                                                        $bbs_no="2810";
                                                        $boardList = BBS_GetList("bbs_flab", $bbs_no, 0, 5, 300, 0, "3학년");
                                                        // 게시판 메뉴 정보 가져오기
                                                        $sql_BoardInfomation = " SELECT TREE_NO, DEPTH FROM ".TABLE_TREE." WHERE CONTENTS LIKE '%".$bbs_no."%' and TREE_ID = '".site_id."' ";
                                                        $row_BoardTreeInfo = $adb->getRow($sql_BoardInfomation, DB_FETCHMODE_ASSOC);
                                                        $param_menuInfo = "site_id=".site_id."&TREE_NO=".$row_BoardTreeInfo[TREE_NO]."&DEPTH=".($row_BoardTreeInfo[DEPTH]+1);
											...
											<!--li>
												...
												<div class="main-board-box">
													<ul>
                                                        ...
                                                        // (테이블명, 코드, 보드타입, 게시물수, 내용글수)
                                                        $bbs_no="2810";
                                                        $boardList = BBS_GetList("bbs_flab", $bbs_no, 0, 5, 300, 0, "4학년");
                                                        // 게시판 메뉴 정보 가져오기
                                                        $sql_BoardInfomation = " SELECT TREE_NO, DEPTH FROM ".TABLE_TREE." WHERE CONTENTS LIKE '%".$bbs_no."%' and TREE_ID = '".site_id."' ";
                                                        $row_BoardTreeInfo = $adb->getRow($sql_BoardInfomation, DB_FETCHMODE_ASSOC);
                                                        $param_menuInfo = "site_id=".site_id."&TREE_NO=".$row_BoardTreeInfo[TREE_NO]."&DEPTH=".($row_BoardTreeInfo[DEPTH]+1);
									...
									<a href="https://flab.ch.ac.kr/board/board.php?site_id=flab&TREE_NO=16325&DEPTH=2" class="btn-more" title="공지사항 더보기">
                                ...
                                <div class="video-gallery-wrapper">
                                    ...
                                    <div class="video-gallery-area">
                                        <?php
                                        $bbs_no="2819";
                                        $boardList = BBS_GetList("bbs_flab", $bbs_no, 1, 2, 300, 0, "");
                                        foreach ( $boardList as $k => $v ) {
                                            ?>
							...
							<div class="main-menu02">
								<ul>
									<li>
										<a href="https://flab.ch.ac.kr/schedule/list.php?site_id=flab&TREE_NO=16324&DEPTH=2">
									...
									<li>
										<a href="https://flab.ch.ac.kr/board/board.php?site_id=flab&TREE_NO=16311&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="https://flab.ch.ac.kr/board/board.php?site_id=flab&TREE_NO=16328&DEPTH=2">
											<span class="image center-crop">
									...
									<li>
										<a href="https://flab.ch.ac.kr/board/board.php?site_id=flab&TREE_NO=16329&DEPTH=2">
											<span class="image center-crop">
					...
					<div class="main-contents03">
						<div class="main-contents-wrapper">
							<div class="main-news-wrapper">
								...
								<a href="https://flab.ch.ac.kr/board/board.php?site_id=flab&TREE_NO=16326&DEPTH=2" class="btn-more" title="학과뉴스 더보기">
